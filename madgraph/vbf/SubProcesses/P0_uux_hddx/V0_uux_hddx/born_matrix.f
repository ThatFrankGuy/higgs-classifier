...
C     
C     Process: u u~ > h d d~ QED<=3 WEIGHTED<=6 [ all = QCD ]
C     Process: c c~ > h s s~ QED<=3 WEIGHTED<=6 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3(W(1,5),W(1,2),GC_47,MDL_MW,MDL_WW,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,7),W(1,4),W(1,3),GC_31,AMP(2))
