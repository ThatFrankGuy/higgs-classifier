...
C     Amplitude(s) for born diagram with ID 1
      ...
      CALL MP_FFV2_3(W(1,1),W(1,4),GC_47,MDL_MW,MDL_WW,W(1,8))
      CALL MP_FFV2_3(W(1,5),W(1,2),GC_47,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for born diagram with ID 2
      CALL MP_VVS1_0(W(1,8),W(1,9),W(1,3),GC_31,AMP(2))
...
C     Counter-term amplitude(s) for loop diagram number 3
     ...
     $ ,AMPL(1,1))
      CALL MP_VVS1_2(W(1,8),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,11))
C     Counter-term amplitude(s) for loop diagram number 4
      CALL MP_FFV2_0(W(1,5),W(1,2),W(1,11),R2_SXCW,AMPL(1,2))
      CALL MP_VVS1_1(W(1,9),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,12))
C     Counter-term amplitude(s) for loop diagram number 5
      CALL MP_FFV2_0(W(1,1),W(1,4),W(1,12),R2_SXCW,AMPL(1,3))
