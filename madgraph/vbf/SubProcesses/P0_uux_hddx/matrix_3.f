...
C     
C     Process: u g > h d u d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: c g > h s c s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3(W(1,1),W(1,4),GC_47,MDL_MW,MDL_WW,W(1,10))
      CALL FFV1_1(W(1,5),W(1,2),GC_5,ZERO,ZERO,W(1,7))
      CALL VVS1_2(W(1,10),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,6),W(1,7),W(1,11),GC_47,AMP(3))
      CALL FFV1_2(W(1,6),W(1,2),GC_5,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,10),W(1,5),W(1,11),GC_47,AMP(4))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_47,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 7
      CALL VVS1_0(W(1,2),W(1,9),W(1,3),GC_31,AMP(7))
