...
C     
C     Process: u~ d > h s c~ g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: c~ s > h d u~ g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,8),W(1,4),W(1,9),GC_47,AMP(2))
      CALL FFV1_1(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,8))
      CALL FFV2_3(W(1,5),W(1,4),GC_47,MDL_MW,MDL_WW,W(1,9))
      CALL FFV2_3(W(1,2),W(1,8),GC_47,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,9),W(1,5),W(1,3),GC_31,AMP(3))
      CALL FFV1_2(W(1,2),W(1,6),GC_5,ZERO,ZERO,W(1,5))
      CALL FFV2_3(W(1,5),W(1,1),GC_47,MDL_MW,MDL_WW,W(1,6))
