...
C     Coefficient construction for loop diagram with ID 3
      CALL FFV1L2P0_3(PL(0,0),W(1,4),GC_5,ZERO,ZERO,PL(0,1),COEFS)
      ...
      CALL FFV2L2_1(PL(0,2),W(1,10),GC_47,ZERO,ZERO,PL(0,3),COEFS)
...
C     Coefficient construction for loop diagram with ID 4
      ...
      CALL FFV1L3_1(PL(0,4),W(1,5),GC_5,ZERO,ZERO,PL(0,5),COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      ...
      CALL FFV1L3_2(PL(0,7),W(1,2),GC_5,ZERO,ZERO,PL(0,8),COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      CALL FFV1L3_2(PL(0,7),W(1,4),GC_5,ZERO,ZERO,PL(0,10),COEFS)
