...
C     
C     Process: u~ d > h u~ d g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: c~ s > h c~ s g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_3(W(1,2),W(1,1),GC_47,MDL_MW,MDL_WW,W(1,7))
      CALL FFV1_2(W(1,4),W(1,6),GC_5,ZERO,ZERO,W(1,8))
      CALL VVS1_1(W(1,7),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,8),W(1,5),W(1,9),GC_47,AMP(1))
      CALL FFV1_1(W(1,5),W(1,6),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,7),W(1,9),GC_47,AMP(2))
      CALL FFV2_5_3(W(1,4),W(1,1),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,9))
      CALL FFV1_2(W(1,2),W(1,6),GC_5,ZERO,ZERO,W(1,10))
      CALL VVS1_1(W(1,9),W(1,3),GC_32,MDL_MZ,MDL_WZ,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,10),W(1,5),W(1,11),-GC_22,GC_23,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,2),W(1,7),W(1,11),-GC_22,GC_23,AMP(4))
      CALL FFV1_1(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,11))
      CALL FFV2_3_3(W(1,2),W(1,5),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,6))
      CALL FFV2_5_3(W(1,4),W(1,11),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 5
      CALL VVS1_0(W(1,6),W(1,7),W(1,3),GC_32,AMP(5))
      CALL FFV2_3(W(1,4),W(1,5),GC_47,MDL_MW,MDL_WW,W(1,7))
      CALL FFV2_3(W(1,2),W(1,11),GC_47,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL VVS1_0(W(1,7),W(1,5),W(1,3),GC_31,AMP(6))
      CALL FFV2_5_3(W(1,8),W(1,1),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL VVS1_0(W(1,6),W(1,5),W(1,3),GC_32,AMP(7))
      CALL FFV2_3(W(1,10),W(1,1),GC_47,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 8
      CALL VVS1_0(W(1,7),W(1,5),W(1,3),GC_31,AMP(8))
      JAMP(1)=-AMP(1)-AMP(2)
      JAMP(2)=+AMP(3)+AMP(4)
      JAMP(3)=+AMP(5)+AMP(7)
      JAMP(4)=-AMP(6)-AMP(8)
