...
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,8),W(1,9),W(1,3),GC_31,AMP(1))
...
C     Amplitude(s) for diagram number 8
      CALL VVS1_0(W(1,8),W(1,6),W(1,3),GC_31,AMP(8))
      JAMP(1)=-AMP(2)-AMP(6)
      JAMP(2)=+AMP(1)+AMP(8)
      JAMP(3)=+AMP(4)+AMP(5)
      JAMP(4)=-AMP(3)-AMP(7)
