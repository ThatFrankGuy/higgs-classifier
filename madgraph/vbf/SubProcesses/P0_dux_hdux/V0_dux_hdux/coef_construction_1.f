...
C     Coefficient construction for loop diagram with ID 4
      CALL FFV1L2P0_3(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,4),COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      CALL FFV1L3_1(PL(0,4),W(1,2),GC_5,ZERO,ZERO,PL(0,7),COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      CALL FFV1L1P0_3(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,9),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,9))
      CALL FFV1L3_2(PL(0,9),W(1,5),GC_5,ZERO,ZERO,PL(0,10),COEFS)
