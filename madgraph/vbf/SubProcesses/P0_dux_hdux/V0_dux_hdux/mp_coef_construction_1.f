...
C     Coefficient construction for loop diagram with ID 4
      CALL MP_FFV1L2P0_3(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,4),COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      CALL MP_FFV1L3_1(PL(0,4),W(1,2),GC_5,ZERO,ZERO,PL(0,7),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1,7))
      CALL MP_FFV2L2_1(PL(0,7),W(1,12),GC_47,ZERO,ZERO,PL(0,8),COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,7),4,COEFS,4,4,WL(1,0,1,8))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,8),2,4,3,1,1,7,H)
C     Coefficient construction for loop diagram with ID 6
      CALL MP_FFV1L1P0_3(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,9),COEFS)
      CALL MP_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,9))
      CALL MP_FFV1L3_2(PL(0,9),W(1,5),GC_5,ZERO,ZERO,PL(0,10),COEFS)
