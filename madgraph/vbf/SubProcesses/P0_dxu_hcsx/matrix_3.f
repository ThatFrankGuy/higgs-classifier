...
C     
C     Process: d~ g > h c s~ u~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: s~ g > h u d~ c~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
