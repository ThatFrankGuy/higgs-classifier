...
C     
C     Process: g u > h c d s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g c > h u s d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
