...
C     
C     Process: d~ u > h c s~ QED<=3 WEIGHTED<=6 [ all = QCD ]
C     Process: s~ c > h u d~ QED<=3 WEIGHTED<=6 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_3(W(1,5),W(1,4),GC_47,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,6),W(1,2),W(1,3),GC_31,AMP(1))
