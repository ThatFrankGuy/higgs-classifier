...
C     
C     Process: g c > h d c d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g u > h s u s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3_3(W(1,6),W(1,9),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,10))
