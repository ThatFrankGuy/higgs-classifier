...
C     
C     Process: g d > h c d c~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g s > h u s u~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3_3(W(1,2),W(1,10),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
