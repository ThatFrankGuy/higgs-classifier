...
C     
C     Process: d d > h d d QED<=3 [ all = QCD ]
C     Process: s s > h s s QED<=3 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      DATA IDEN_VALUES /72, 72, 72, 72, 72/
      INTEGER IJ_VALUES(5)
      DATA IJ_VALUES /1, 2, 5, 1, 2/
C     
C     GLOBAL VARIABLES
C     
      ...
      DO IHEL=BACK_HEL,-BACK_HEL,STEP_HEL
        ...
        IF (COND_IJ) THEN
          ...
          IF (.NOT. CALCULATEDBORN) THEN
            ...
            CALL FFV2_3_3(W(1,1),W(1,4),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1
     $       ,6))
            CALL FFV2_3_3(W(1,2),W(1,5),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1
     $       ,7))
C           Amplitude(s) for diagram number 1
            CALL VVS1_0(W(1,6),W(1,7),W(1,3),GC_32,AMP(1))
            CALL FFV2_3_3(W(1,1),W(1,5),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1
     $       ,7))
            CALL FFV2_3_3(W(1,2),W(1,4),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1
     $       ,5))
C           Amplitude(s) for diagram number 2
            CALL VVS1_0(W(1,7),W(1,5),W(1,3),GC_32,AMP(2))
            DO I=1,NGRAPHS
