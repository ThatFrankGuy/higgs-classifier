...
C     Coefficient construction for loop diagram with ID 3
      ...
      CALL MP_FFV2_3L2_1(PL(0,2),W(1,10),-GC_22,GC_23,ZERO,ZERO,PL(0,3)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 4
      ...
      CALL MP_FFV2_3L2_1(PL(0,4),W(1,11),-GC_22,GC_23,ZERO,ZERO,PL(0,5)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      ...
      CALL MP_FFV2_3L2_1(PL(0,7),W(1,12),-GC_22,GC_23,ZERO,ZERO,PL(0,8)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL MP_FFV2_3L2_1(PL(0,9),W(1,13),-GC_22,GC_23,ZERO,ZERO,PL(0
     $ ,10),COEFS)
