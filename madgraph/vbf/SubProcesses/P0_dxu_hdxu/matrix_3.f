...
C     
C     Process: d~ g > h d~ u u~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: s~ g > h s~ c c~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3_3(W(1,4),W(1,7),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,9),W(1,10),W(1,3),GC_32,AMP(2))
      CALL FFV2_3_3(W(1,4),W(1,1),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,10))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3_3(W(1,6),W(1,1),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,2))
