...
C     
C     Process: d~ d > h s s~ g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: s~ s > h d d~ g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,8),W(1,4),W(1,9),-GC_22,GC_23,AMP(2))
      CALL FFV1_1(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,8))
      CALL FFV2_3_3(W(1,5),W(1,4),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,9))
      CALL FFV2_3_3(W(1,2),W(1,8),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
