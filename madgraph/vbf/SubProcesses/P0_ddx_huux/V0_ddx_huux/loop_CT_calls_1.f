...
C     CutTools call for loop numbers 2
      CALL LOOP_3(1,4,11,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,2)
C     CutTools call for loop numbers 3
      CALL LOOP_3(1,2,12,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,3)
C     CutTools call for loop numbers 4
      CALL LOOP_3(4,5,13,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,4)
