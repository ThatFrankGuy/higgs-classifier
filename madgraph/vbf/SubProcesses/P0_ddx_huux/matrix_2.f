...
C     
C     Process: g d~ > h u u~ d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g s~ > h c c~ s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,7),W(1,11),W(1,3),GC_31,AMP(3))
