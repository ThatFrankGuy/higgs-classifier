...
C     
C     Process: d g > h u d u~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: s g > h c s c~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL VVS1_1(W(1,10),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,11))
...
C     Amplitude(s) for diagram number 7
      CALL VVS1_0(W(1,9),W(1,2),W(1,3),GC_31,AMP(7))
