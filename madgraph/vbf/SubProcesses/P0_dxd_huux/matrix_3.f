...
C     
C     Process: d~ g > h u u~ d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: s~ g > h c c~ s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3(W(1,5),W(1,1),GC_47,MDL_MW,MDL_WW,W(1,10))
...
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,10),W(1,4),W(1,11),GC_47,AMP(4))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3(W(1,7),W(1,1),GC_47,MDL_MW,MDL_WW,W(1,6))
