...
C     
C     Process: d~ d > h u u~ QED<=3 [ all = QCD ]
C     Process: s~ s > h c c~ QED<=3 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
      ...
      DO IHEL=BACK_HEL,-BACK_HEL,STEP_HEL
        ...
        IF (COND_IJ) THEN
          ...
          IF (.NOT. CALCULATEDBORN) THEN
            ...
            CALL FFV2_3_3(W(1,2),W(1,1),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1
     $       ,6))
            CALL FFV2_5_3(W(1,5),W(1,4),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1
     $       ,7))
