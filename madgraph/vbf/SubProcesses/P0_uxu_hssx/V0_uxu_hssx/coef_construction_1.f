...
C     Coefficient construction for loop diagram with ID 2
      ...
      CALL FFV2_5L1_2(PL(0,2),W(1,8),GC_22,GC_23,ZERO,ZERO,PL(0,3)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 3
      CALL FFV1L1P0_3(PL(0,0),W(1,4),GC_5,ZERO,ZERO,PL(0,4),COEFS)
      ...
      CALL FFV2_3L1_2(PL(0,5),W(1,9),-GC_22,GC_23,ZERO,ZERO,PL(0,6)
     $ ,COEFS)
