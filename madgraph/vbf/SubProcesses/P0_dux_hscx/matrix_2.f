...
C     
C     Process: g u~ > h s c~ d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g c~ > h d u~ s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3(W(1,6),W(1,2),GC_47,MDL_MW,MDL_WW,W(1,7))
      CALL FFV2_3(W(1,5),W(1,9),GC_47,MDL_MW,MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,10),W(1,7),W(1,3),GC_31,AMP(2))
      CALL FFV1_2(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,10))
      CALL FFV2_3(W(1,10),W(1,4),GC_47,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,5),W(1,7),W(1,3),GC_31,AMP(3))
