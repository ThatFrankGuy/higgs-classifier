...
C     Amplitude(s) for born diagram with ID 1
      ...
      CALL MP_FFV2_3(W(1,4),W(1,2),GC_47,MDL_MW,MDL_WW,W(1,9))
...
C     Counter-term amplitude(s) for loop diagram number 3
      CALL MP_FFV2_0(W(1,4),W(1,2),W(1,10),R2_SXCW,AMPL(1,1))
...
C     Counter-term amplitude(s) for loop diagram number 5
      CALL MP_FFV2_3_0(W(1,4),W(1,1),W(1,12),-R2_UUZ_V2,R2_UUZ_V5
     $ ,AMPL(1,3))
