...
C     
C     Process: d~ u~ > h d~ u~ QED<=3 WEIGHTED<=6 [ all = QCD ]
C     Process: s~ c~ > h s~ c~ QED<=3 WEIGHTED<=6 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3(W(1,4),W(1,2),GC_47,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,7),W(1,5),W(1,3),GC_31,AMP(2))
