...
C     
C     Process: u~ g > h u~ s s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: c~ g > h c~ d d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_5_3(W(1,4),W(1,7),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,9))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_5_3(W(1,7),W(1,1),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,4))
