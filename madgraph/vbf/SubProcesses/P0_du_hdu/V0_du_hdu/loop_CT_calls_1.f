...
C     CutTools call for loop numbers 1
      CALL LOOP_3(2,4,10,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,1)
...
C     CutTools call for loop numbers 3
      CALL LOOP_3(1,4,12,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,3)
C     CutTools call for loop numbers 4
      CALL LOOP_3(2,5,13,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,4)
