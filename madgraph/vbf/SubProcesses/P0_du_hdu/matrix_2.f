...
C     
C     Process: g u > h d u d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g c > h s c s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,10),W(1,9),W(1,3),GC_31,AMP(2))
...
C     Amplitude(s) for diagram number 4
      CALL VVS1_0(W(1,11),W(1,9),W(1,3),GC_31,AMP(4))
...
C     Amplitude(s) for diagram number 5
      CALL VVS1_0(W(1,9),W(1,10),W(1,3),GC_31,AMP(5))
...
C     Amplitude(s) for diagram number 7
      CALL VVS1_0(W(1,9),W(1,6),W(1,3),GC_31,AMP(7))
