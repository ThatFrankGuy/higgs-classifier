...
C     Amplitude(s) for born diagram with ID 1
      ...
      CALL MP_VVS1_1(W(1,7),W(1,3),GC_32,MDL_MZ,MDL_WZ,W(1,8))
C     Counter-term amplitude(s) for loop diagram number 2
      CALL MP_FFV2_5_0(W(1,1),W(1,2),W(1,8),R2_UUZ_V2,R2_UUZ_V5,AMPL(1
     $ ,1))
      CALL MP_VVS1_1(W(1,6),W(1,3),GC_32,MDL_MZ,MDL_WZ,W(1,9))
C     Counter-term amplitude(s) for loop diagram number 3
      CALL MP_FFV2_5_0(W(1,5),W(1,4),W(1,9),R2_UUZ_V2,R2_UUZ_V5,AMPL(1
     $ ,2))
