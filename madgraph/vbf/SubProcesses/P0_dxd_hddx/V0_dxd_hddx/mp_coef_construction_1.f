...
C     Coefficient construction for loop diagram with ID 4
      ...
      CALL MP_FFV2_3L2_1(PL(0,5),W(1,11),-GC_22,GC_23,ZERO,ZERO,PL(0,6)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      ...
      CALL MP_FFV2_3L1_2(PL(0,8),W(1,12),-GC_22,GC_23,ZERO,ZERO,PL(0,9)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL MP_FFV2_3L1_2(PL(0,10),W(1,13),-GC_22,GC_23,ZERO,ZERO,PL(0
     $ ,11),COEFS)
