...
C     
C     Process: d~ d > h d d~ QED<=3 WEIGHTED<=6 [ all = QCD ]
C     Process: s~ s > h s s~ QED<=3 WEIGHTED<=6 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3_3(W(1,5),W(1,1),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,7))
      CALL FFV2_3_3(W(1,2),W(1,4),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
