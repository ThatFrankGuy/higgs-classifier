...
C     
C     Process: g s > h c d u~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g d > h u s c~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_3(W(1,6),W(1,5),GC_47,MDL_MW,MDL_WW,W(1,8))
      CALL FFV2_3(W(1,7),W(1,4),GC_47,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,8),W(1,9),W(1,3),GC_31,AMP(1))
      CALL FFV1_1(W(1,4),W(1,1),GC_5,ZERO,ZERO,W(1,9))
      CALL FFV2_3(W(1,2),W(1,9),GC_47,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,8),W(1,7),W(1,3),GC_31,AMP(2))
      CALL FFV1_1(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,7))
      CALL FFV2_3(W(1,2),W(1,4),GC_47,MDL_MW,MDL_WW,W(1,8))
      CALL FFV2_3(W(1,6),W(1,7),GC_47,MDL_MW,MDL_WW,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,4),W(1,8),W(1,3),GC_31,AMP(3))
      CALL FFV1_2(W(1,6),W(1,1),GC_5,ZERO,ZERO,W(1,4))
      CALL FFV2_3(W(1,4),W(1,5),GC_47,MDL_MW,MDL_WW,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL VVS1_0(W(1,6),W(1,8),W(1,3),GC_31,AMP(4))
      JAMP(1)=-AMP(1)-AMP(2)
      JAMP(2)=-AMP(3)-AMP(4)
      MATRIX_2 = 0.D0
      DO I = 1, NCOLOR
