...
C     
C     Process: d~ g > h d~ c c~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: s~ g > h s~ u u~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_5_3(W(1,6),W(1,5),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,8))
...
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,6),W(1,7),W(1,10),GC_22,GC_23,AMP(2))
      CALL FFV1_2(W(1,6),W(1,2),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,7),W(1,5),W(1,10),GC_22,GC_23,AMP(3))
