...
C     
C     Process: d s > h d s g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: s d > h s d g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
