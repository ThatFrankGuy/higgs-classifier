...
C     Coefficient construction for loop diagram with ID 4
      ...
      CALL MP_FFV1L3_1(PL(0,4),W(1,4),GC_5,ZERO,ZERO,PL(0,5),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1,5))
      CALL MP_FFV2_5L2_1(PL(0,5),W(1,11),GC_22,GC_23,ZERO,ZERO,PL(0,6)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      CALL MP_FFV1L1P0_3(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,7),COEFS)
      CALL MP_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,7))
      CALL MP_FFV1L3_2(PL(0,7),W(1,5),GC_5,ZERO,ZERO,PL(0,8),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,7),4,COEFS,4,4,WL(1,0,1,8))
      CALL MP_FFV2_5L1_2(PL(0,8),W(1,12),GC_22,GC_23,ZERO,ZERO,PL(0,9)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      CALL MP_FFV1L3_2(PL(0,7),W(1,2),GC_5,ZERO,ZERO,PL(0,10),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,7),4,COEFS,4,4,WL(1,0,1,10))
      CALL MP_FFV2_5L1_2(PL(0,10),W(1,13),GC_22,GC_23,ZERO,ZERO,PL(0
     $ ,11),COEFS)
