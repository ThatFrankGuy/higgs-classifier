...
C     
C     Process: u s > h u s g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: c d > h c d g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_5_3(W(1,8),W(1,4),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,9),W(1,5),W(1,3),GC_32,AMP(3))
      CALL FFV1_1(W(1,4),W(1,6),GC_5,ZERO,ZERO,W(1,5))
      CALL FFV2_5_3(W(1,1),W(1,5),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,6))
