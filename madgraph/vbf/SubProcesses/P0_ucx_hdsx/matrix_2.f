...
C     
C     Process: g c~ > h d s~ u~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g u~ > h s d~ c~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
