...
C     
C     Process: u g > h c d s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: c g > h u s d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
