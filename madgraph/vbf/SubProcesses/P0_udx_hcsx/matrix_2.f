...
C     
C     Process: g d~ > h c s~ u~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g s~ > h u d~ c~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
