...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_5_3(W(1,5),W(1,1),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,10))
...
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,10),W(1,4),W(1,11),GC_22,GC_23,AMP(4))
      CALL FFV2_5_3(W(1,6),W(1,1),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,11))
      CALL VVS1_1(W(1,11),W(1,3),GC_32,MDL_MZ,MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV2_5_0(W(1,5),W(1,7),W(1,6),GC_22,GC_23,AMP(5))
      CALL FFV1_2(W(1,5),W(1,2),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,7),W(1,4),W(1,6),GC_22,GC_23,AMP(6))
      CALL FFV2_5_3(W(1,7),W(1,1),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL VVS1_0(W(1,9),W(1,6),W(1,3),GC_32,AMP(7))
      CALL FFV2_5_3(W(1,10),W(1,1),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,6))
