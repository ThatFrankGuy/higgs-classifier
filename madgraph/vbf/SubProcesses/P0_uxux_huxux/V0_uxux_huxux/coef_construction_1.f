...
C     Coefficient construction for loop diagram with ID 4
      CALL FFV1L3_2(PL(0,1),W(1,4),GC_5,ZERO,ZERO,PL(0,4),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,4))
      CALL FFV2_5L1_2(PL(0,4),W(1,11),GC_22,GC_23,ZERO,ZERO,PL(0,5)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      ...
      CALL FFV1L3_2(PL(0,6),W(1,5),GC_5,ZERO,ZERO,PL(0,7),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,6),4,COEFS,4,4,WL(1,0,1,7))
      CALL FFV2_5L1_2(PL(0,7),W(1,12),GC_22,GC_23,ZERO,ZERO,PL(0,8)
     $ ,COEFS)
