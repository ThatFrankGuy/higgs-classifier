...
C      if true.
      ...
      CALL MP_FFV2_5_3(W(1,4),W(1,1),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,6))
      CALL MP_FFV2_5_3(W(1,5),W(1,2),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for born diagram with ID 1
      CALL MP_VVS1_0(W(1,6),W(1,7),W(1,3),GC_32,AMP(1))
      CALL MP_FFV2_5_3(W(1,5),W(1,1),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,8))
      CALL MP_FFV2_5_3(W(1,4),W(1,2),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,9))
...
C     Counter-term amplitude(s) for loop diagram number 3
      CALL MP_FFV2_5_0(W(1,5),W(1,2),W(1,10),R2_UUZ_V2,R2_UUZ_V5
     $ ,AMPL(1,1))
      CALL MP_VVS1_1(W(1,8),W(1,3),GC_32,MDL_MZ,MDL_WZ,W(1,11))
C     Counter-term amplitude(s) for loop diagram number 4
      CALL MP_FFV2_5_0(W(1,4),W(1,2),W(1,11),R2_UUZ_V2,R2_UUZ_V5
     $ ,AMPL(1,2))
...
C     Counter-term amplitude(s) for loop diagram number 6
      CALL MP_FFV2_5_0(W(1,4),W(1,1),W(1,13),R2_UUZ_V2,R2_UUZ_V5
     $ ,AMPL(1,4))
