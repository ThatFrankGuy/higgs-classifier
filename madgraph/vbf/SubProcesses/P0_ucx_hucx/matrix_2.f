...
C     
C     Process: g c~ > h u c~ u~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g u~ > h c u~ c~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_5_3(W(1,5),W(1,7),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,9))
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_5_3(W(1,6),W(1,9),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,7),W(1,10),W(1,3),GC_32,AMP(2))
      CALL FFV1_2(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,10))
      CALL FFV2_5_3(W(1,10),W(1,2),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,8),W(1,5),W(1,3),GC_32,AMP(3))
      CALL FFV1_2(W(1,6),W(1,1),GC_5,ZERO,ZERO,W(1,5))
      CALL FFV2_5_3(W(1,5),W(1,4),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL VVS1_0(W(1,7),W(1,6),W(1,3),GC_32,AMP(4))
      JAMP(1)=-AMP(1)-AMP(3)
      JAMP(2)=-AMP(2)-AMP(4)
      MATRIX_2 = 0.D0
      DO I = 1, NCOLOR
