...
C     
C     Process: u s > h c d g QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_47,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3(W(1,8),W(1,5),GC_47,MDL_MW,MDL_WW,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,4),W(1,9),W(1,3),GC_31,AMP(3))
