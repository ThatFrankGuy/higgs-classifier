...
C     Amplitude(s) for born diagram with ID 1
      ...
      CALL VVS1_1(W(1,7),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,8))
C     Counter-term amplitude(s) for loop diagram number 2
      CALL FFV2_0(W(1,1),W(1,5),W(1,8),R2_SXCW,AMPL(1,1))
      CALL VVS1_2(W(1,6),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,9))
C     Counter-term amplitude(s) for loop diagram number 3
      CALL FFV2_0(W(1,2),W(1,4),W(1,9),R2_SXCW,AMPL(1,2))
