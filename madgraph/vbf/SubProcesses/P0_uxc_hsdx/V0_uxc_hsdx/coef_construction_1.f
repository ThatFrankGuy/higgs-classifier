...
C     Coefficient construction for loop diagram with ID 2
      ...
      CALL FFV2L1_2(PL(0,2),W(1,8),GC_47,ZERO,ZERO,PL(0,3),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,3))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,3),2,4,1,1,1,3,H)
C     Coefficient construction for loop diagram with ID 3
      ...
      CALL FFV2L2_1(PL(0,5),W(1,9),GC_47,ZERO,ZERO,PL(0,6),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,5),4,COEFS,4,4,WL(1,0,1,6))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,6),2,4,2,1,1,4,H)
