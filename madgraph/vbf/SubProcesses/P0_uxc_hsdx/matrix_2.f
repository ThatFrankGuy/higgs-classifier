...
C     
C     Process: g c > h s u d~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     Process: g u > h d c s~ QED<=3 WEIGHTED<=7 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,7),W(1,8),W(1,3),GC_31,AMP(2))
