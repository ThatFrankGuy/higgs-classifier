      SUBROUTINE ML5_0_2_1_HELAS_CALLS_AMPB_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     Counter-term amplitude(s) for loop diagram number 3
      ...
      CALL FFV1P0_3(W(1,2),W(1,10),GC_5,ZERO,ZERO,W(1,11))
C     Counter-term amplitude(s) for loop diagram number 5
      CALL VVS1_0(W(1,4),W(1,11),W(1,3),R2_GGHB,AMPL(1,3))
      CALL FFV1_2(W(1,2),W(1,4),GC_5,ZERO,ZERO,W(1,12))
...
C     Counter-term amplitude(s) for loop diagram number 9
      ...
      CALL FFV1_1(W(1,5),W(1,4),GC_5,ZERO,ZERO,W(1,15))
      CALL FFV1P0_3(W(1,2),W(1,15),GC_5,ZERO,ZERO,W(1,16))
