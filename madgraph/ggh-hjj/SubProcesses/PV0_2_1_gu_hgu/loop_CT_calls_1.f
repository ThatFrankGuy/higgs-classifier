      SUBROUTINE ML5_0_2_1_LOOP_CT_CALLS_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     CutTools call for loop # 14
      CALL ML5_0_2_1_LOOP_4(1,3,9,4,DCMPLX(MDL_MB),DCMPLX(MDL_MB)
...
C     CutTools call for loop # 34
      CALL ML5_0_2_1_LOOP_4(1,3,9,4,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
...
C     CutTools call for loop # 37
      CALL ML5_0_2_1_LOOP_3(1,3,16,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),3,I_SO,37)
C     CutTools call for loop # 38
      CALL ML5_0_2_1_LOOP_3(1,3,16,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),3,I_SO,38)
C     CutTools call for loop # 39
      CALL ML5_0_2_1_LOOP_3(3,4,17,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
