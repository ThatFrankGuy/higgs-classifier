      SUBROUTINE ML5_0_4_6_LOOP_CT_CALLS_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     CutTools call for loop # 1
      CALL ML5_0_4_6_LOOP_3(3,6,7,DCMPLX(MDL_MB),DCMPLX(MDL_MB)
     $ ,DCMPLX(MDL_MB),3,I_SO,1)
C     CutTools call for loop # 2
      CALL ML5_0_4_6_LOOP_3(3,6,7,DCMPLX(MDL_MB),DCMPLX(MDL_MB)
     $ ,DCMPLX(MDL_MB),3,I_SO,2)
C     CutTools call for loop # 3
      CALL ML5_0_4_6_LOOP_3(3,6,7,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
