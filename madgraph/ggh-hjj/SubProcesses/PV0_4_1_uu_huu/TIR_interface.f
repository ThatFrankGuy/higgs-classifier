      SUBROUTINE ML5_0_4_1_TIRLOOP(I_SQSO,I_LOOPGROUP,I_LIB,NLOOPLINE
...
C     NUMBER OF INDEPEDENT LOOPCOEFS FOR RANK=RANK
      ...
      IF (TIR_CACHE_SIZE.EQ.0) THEN
        TIR_CACHE_INDEX = 0
      ELSE
        TIR_CACHE_INDEX = ML5_0_4_1_TIRCACHE_INDEX(CTMODE)
...
C       CONVERT TO MADLOOP CONVENTION
        CALL ML5_0_4_1_CONVERT_IREGI_COEFFS(RANK,PJCOEFS,TIRCOEFS)
        CASE(7)
C       COLLIER
        CALL ML5_0_4_1_COLLIERLOOP(CTMODE,NLOOPLINE,RANK,PL,PDEN,M2L
...
C     ENDIF
      ...
      SUBROUTINE ML5_0_4_1_SWITCH_ORDER(CTMODE,NLOOPLINE,PL,PDEN,M2L)
      IMPLICIT NONE
      ...
      SUBROUTINE ML5_0_4_1_MP_SWITCH_ORDER(CTMODE,NLOOPLINE,PL,PDEN
     $ ,M2L)
      IMPLICIT NONE
...
C     The initialization below is for CT v1.9.2+
      ...
      SUBROUTINE ML5_0_4_1_CHOOSE_LOOPLIB(LIBINDEX,NLOOPLINE,RANK
...
C      so that CutTools limitations can be correctly implemented
      ...
      DATA (HAS_AN_HEFT_VERTEX(I),I=     1,     4) /.FALSE.,.FALSE.
     $ ,.FALSE.,.FALSE./
C     
C     GLOBAL VARIABLES
C     
...
C       DP EVALUATION
     ...
     $   ,HAS_AN_HEFT_VERTEX(LOOP_ID),MAX_SPIN_CONNECTED_TO_LOOP,LPASS)
      ...
      SUBROUTINE ML5_0_4_1_CLEAR_TIR_CACHE()
      IMPLICIT NONE
      ...
      INTEGER FUNCTION ML5_0_4_1_TIRCACHE_INDEX(CTMODE)
C     Mapping function from CTMode to index and the TIR_cache
      ...
      ML5_0_4_1_TIRCACHE_INDEX=CTMODE
      IF(ML5_0_4_1_TIRCACHE_INDEX.GT.2) THEN
C       This way, the CTMode 4 and 5 are sent to 3 and 4 respectively.
        ML5_0_4_1_TIRCACHE_INDEX = ML5_0_4_1_TIRCACHE_INDEX-1
      ENDIF
...
C      could do it here
      ...
      SUBROUTINE ML5_0_4_1_CONVERT_IREGI_COEFFS(RANK,IREGICOEFS
     $ ,TIRCOEFS)
C     GLOABLE VARIABLES
