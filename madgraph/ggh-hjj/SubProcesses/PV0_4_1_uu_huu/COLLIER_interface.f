      SUBROUTINE ML5_0_4_1_COLLIERLOOP(CTMODE, NLOOPLINE,RANK,PL,PDEN
...
C     
      ...
      COMMON/ML5_0_4_1_COLLIER_TIR_COEFS/TIR_COEFS_DIRECT_MODE
     $ ,TIR_COEFS_ERROR,LOOP_ID_DONE

      INTEGER COLLIER_CACHE_ACTIVE, NCALLS_IN_CACHE(4),
     $  NCOLLIERCALLS(4)
      LOGICAL MUST_INIT_EVENT
      COMMON/ML5_0_4_1_COLLIER_CACHE_STATUS/COLLIER_CACHE_ACTIVE
...
C       Apply the loop-direction switching here.
        CALL ML5_0_4_1_SWITCH_ORDER(CTMODE,NLOOPLINE,PL,PDEN,M2L)
      ENDIF
...
C              complex phase leads to slightly more accurate estimates
     ...
     $         /MAXCOEFFORRANK(CURR_RANK))*TIRCOEFS(I,K)
      ...
      END SUBROUTINE ML5_0_4_1_COLLIERLOOP

      SUBROUTINE ML5_0_4_1_CLEAR_COLLIER_CACHE()
...
C     Reinitialize the ML cache for COLLIER
      ...
      SUBROUTINE ML5_0_4_1_SET_COLLIER_GLOBAL_CACHE(ONOFF)
C     
...
C      the event when called.
     ...
     $  NCALLS_IN_CACHE, NCOLLIERCALLS,MUST_INIT_EVENT
      ...
      COMMON/ML5_0_4_1_COLLIER_CACHE_RELEVANT_PARAMS/USERHEL_BU
