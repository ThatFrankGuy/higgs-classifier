...
C     
      ...
      COMMON/ML5_0_4_3_CHOSEN_LOOP_SQSO/CHOSEN_LOOP_SO_CONFIGS
...
C     
      IF (INIT) THEN
        INIT=.FALSE.
        CALL ML5_0_4_3_GET_ANSWER_DIMENSION(MATELEM_ARRAY_DIM)
        ALLOCATE(MATELEM(0:3,0:MATELEM_ARRAY_DIM))
        CALL ML5_0_4_3_GET_NSQSO_LOOP(NSQUAREDSO_LOOP)
