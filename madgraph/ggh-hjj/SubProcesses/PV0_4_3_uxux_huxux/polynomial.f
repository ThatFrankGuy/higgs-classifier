      MODULE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      IMPLICIT NONE
...
C      of two lower rank coefs.
      ...
      END MODULE ML5_0_4_3_POLYNOMIAL_CONSTANTS
...
C     amplitude level so that no multiplication is performed.
      ...
      SUBROUTINE ML5_0_4_3_CREATE_LOOP_COEFS(LOOP_WF,RANK,LCUT_SIZE
...
C     
      ...
      COMMON/ML5_0_4_3_LCOEFS/LOOPCOEFS
C     
C     BEGIN CODE
C     
      CONST=CMPLX((ONE*MULTIPLIER)/SYMFACT,ZERO,KIND=16)

      CALL ML5_0_4_3_MERGE_WL(LOOP_WF,RANK,LCUT_SIZE,CONST,LOOPCOEFS(0
     $ ,LOOP_GROUP_NUMBER))

      END

      SUBROUTINE ML5_0_4_3_INVERT_MOMENTA_IN_POLYNOMIAL(NCOEFS
     $ ,POLYNOMIAL)
...
C     amplitude level so that no multiplication is performed.
      ...
      SUBROUTINE MP_ML5_0_4_3_CREATE_LOOP_COEFS(LOOP_WF,RANK,LCUT_SIZE
     $ ,LOOP_GROUP_NUMBER,SYMFACT,MULTIPLIER)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      IMPLICIT NONE
C     
...
C     
      ...
      COMMON/ML5_0_4_3_MP_LCOEFS/LOOPCOEFS
C     
C     BEGIN CODE
C     
      CONST=CMPLX((ONE*MULTIPLIER)/SYMFACT,ZERO,KIND=16)

      CALL MP_ML5_0_4_3_MERGE_WL(LOOP_WF,RANK,LCUT_SIZE,CONST
     $ ,LOOPCOEFS(0,LOOP_GROUP_NUMBER))

      END

      SUBROUTINE MP_ML5_0_4_3_INVERT_MOMENTA_IN_POLYNOMIAL(NCOEFS
     $ ,POLYNOMIAL)
C     Just a handy subroutine to modify the coefficients for the
C     tranformation q_loop -> -q_loop
C     It is only used for the NINJA interface
...
C     Now the routines to update the wavefunctions
      ...
      SUBROUTINE ML5_0_4_3_EVAL_POLY(C,R,Q,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
     ...
     $   +C(34)*Q(3)*Q(3)*Q(3)
      ...
      SUBROUTINE MP_ML5_0_4_3_EVAL_POLY(C,R,Q,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
     ...
     $   +C(34)*Q(3)*Q(3)*Q(3)
      ...
      SUBROUTINE ML5_0_4_3_ADD_COEFS(A,RA,B,RB)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      INTEGER I
      ...
      SUBROUTINE MP_ML5_0_4_3_ADD_COEFS(A,RA,B,RB)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      INTEGER I
      ...
      SUBROUTINE ML5_0_4_3_MERGE_WL(WL,R,LCUT_SIZE,CONST,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      INTEGER I,J
      ...
      SUBROUTINE MP_ML5_0_4_3_MERGE_WL(WL,R,LCUT_SIZE,CONST,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      INTEGER I,J
      ...
      SUBROUTINE ML5_0_4_3_UPDATE_WL_0_1(A,LCUT_SIZE,B,IN_SIZE
     $ ,OUT_SIZE,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      INTEGER I,J,K
      ...
      SUBROUTINE MP_ML5_0_4_3_UPDATE_WL_0_1(A,LCUT_SIZE,B,IN_SIZE
     $ ,OUT_SIZE,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      INTEGER I,J,K
      ...
      SUBROUTINE ML5_0_4_3_UPDATE_WL_1_1(A,LCUT_SIZE,B,IN_SIZE
     $ ,OUT_SIZE,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      INTEGER I,J,K
      COMPLEX*16 A(MAXLWFSIZE,0:LOOPMAXCOEFS-1,MAXLWFSIZE)
      ...
      SUBROUTINE MP_ML5_0_4_3_UPDATE_WL_1_1(A,LCUT_SIZE,B,IN_SIZE
     $ ,OUT_SIZE,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      INTEGER I,J,K
      COMPLEX*32 A(MAXLWFSIZE,0:LOOPMAXCOEFS-1,MAXLWFSIZE)
      ...
      SUBROUTINE ML5_0_4_3_UPDATE_WL_2_1(A,LCUT_SIZE,B,IN_SIZE
     $ ,OUT_SIZE,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      IMPLICIT NONE
      INTEGER I,J,K,L,M
...
C     Welcome to the computational heart of MadLoop...
     ...
     $           *UPDATER_COEF
      ...
      SUBROUTINE MP_ML5_0_4_3_UPDATE_WL_2_1(A,LCUT_SIZE,B,IN_SIZE
     $ ,OUT_SIZE,OUT)
      USE ML5_0_4_3_POLYNOMIAL_CONSTANTS
      IMPLICIT NONE
      INTEGER I,J,K,L,M
