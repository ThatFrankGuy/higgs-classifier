...
matrix2py.ml5_0_3_1_initialise(os.path.abspath(pjoin(root_path,os.pardir,os.pardir,'Cards','param_card.dat')))
...
finite_loop_me, return_code = matrix2py.ml5_0_3_1_get_me(P, alphas, renormalization_scale, nhel)


print '='*112
print '* %-108s *'%' MadLoop evaluation for the process '
print '* %-108s *'%'   u u~ > h g g QED<=2 [ noborn = QCD ]'
