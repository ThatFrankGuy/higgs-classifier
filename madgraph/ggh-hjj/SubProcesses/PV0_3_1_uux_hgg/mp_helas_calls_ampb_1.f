      SUBROUTINE ML5_0_3_1_MP_HELAS_CALLS_AMPB_1(P,NHEL,H,IC)
C     
...
C     Counter-term amplitude(s) for loop diagram number 5
      ...
      CALL MP_FFV1_2(W(1,1),W(1,4),GC_5,ZERO,ZERO,W(1,10))
      CALL MP_FFV1P0_3(W(1,10),W(1,2),GC_5,ZERO,ZERO,W(1,11))
C     Counter-term amplitude(s) for loop diagram number 13
      CALL MP_VVS1_0(W(1,5),W(1,11),W(1,3),R2_GGHB,AMPL(1,4))
      CALL MP_FFV1_2(W(1,1),W(1,5),GC_5,ZERO,ZERO,W(1,12))
      CALL MP_FFV1P0_3(W(1,12),W(1,2),GC_5,ZERO,ZERO,W(1,13))
C     Counter-term amplitude(s) for loop diagram number 15
      CALL MP_VVS1_0(W(1,4),W(1,13),W(1,3),R2_GGHB,AMPL(1,5))
      CALL MP_FFV1_1(W(1,2),W(1,4),GC_5,ZERO,ZERO,W(1,14))
      CALL MP_FFV1P0_3(W(1,1),W(1,14),GC_5,ZERO,ZERO,W(1,15))
C     Counter-term amplitude(s) for loop diagram number 17
      CALL MP_VVS1_0(W(1,5),W(1,15),W(1,3),R2_GGHB,AMPL(1,6))
      CALL MP_FFV1_1(W(1,2),W(1,5),GC_5,ZERO,ZERO,W(1,16))
      CALL MP_FFV1P0_3(W(1,1),W(1,16),GC_5,ZERO,ZERO,W(1,17))
...
C     Counter-term amplitude(s) for loop diagram number 21
      CALL MP_VVS1_0(W(1,5),W(1,7),W(1,3),R2_GGHT,AMPL(1,8))
C     Counter-term amplitude(s) for loop diagram number 22
      CALL MP_VVS1_0(W(1,4),W(1,8),W(1,3),R2_GGHT,AMPL(1,9))
C     Counter-term amplitude(s) for loop diagram number 25
      CALL MP_VVS1_0(W(1,6),W(1,9),W(1,3),R2_GGHT,AMPL(1,10))
C     Counter-term amplitude(s) for loop diagram number 33
      CALL MP_VVS1_0(W(1,5),W(1,11),W(1,3),R2_GGHT,AMPL(1,11))
C     Counter-term amplitude(s) for loop diagram number 35
      CALL MP_VVS1_0(W(1,4),W(1,13),W(1,3),R2_GGHT,AMPL(1,12))
C     Counter-term amplitude(s) for loop diagram number 37
      CALL MP_VVS1_0(W(1,5),W(1,15),W(1,3),R2_GGHT,AMPL(1,13))
