...
C     Storing concatenated filenames
     ...
     $  4,     5,     6/
      DATA (CONFIG_MAP(I),I=     7,    12) /     7,     8,     9,   
     $  10,    11,    12/
      DATA (CONFIG_MAP(I),I=    13,    18) /     0,     0,     0,   
     $  13,    14,    15/
      DATA (CONFIG_MAP(I),I=    19,    24) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    25,    30) /     0,     0,     0,    
     $  1,     2,     3/
      DATA (CONFIG_MAP(I),I=    31,    36) /     4,     5,     6,    
     $  7,     8,     9/
      DATA (CONFIG_MAP(I),I=    37,    42) /    10,    11,    12,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    43,    48) /    13,    14,    15,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    49,    54) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    55,    60) /     1,     2,     0,    
     $  0,     3,     3/
      DATA (CONFIG_MAP(I),I=    61,    66) /     0,     0,     2,    
     $  0,     1,     0/
      DATA (CONFIG_MAP(I),I=    67,    72) /     4,     4,     5,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    73,    78) /     0,     5,     0,    
     $  0,     6,     6/
      DATA (CONFIG_MAP(I),I=    79,    84) /     7,     7,     8,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    85,    90) /     0,     8,     0,    
     $  0,     9,     9/
      DATA (CONFIG_MAP(I),I=    91,    96) /    10,     0,     0,    
     $  0,    10,     0/
      DATA (CONFIG_MAP(I),I=    97,   102) /     0,     0,    11,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   103,   108) /    11,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   109,   114) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   115,   120) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   121,   126) /     0,    12,     0,    
     $  0,    12,     0/
      DATA (CONFIG_MAP(I),I=   127,   132) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   133,   138) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   139,   144) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   145,   150) /    13,    13,    14,   
     $  14,    15,    15/
      DATA (CONFIG_MAP(I),I=   151,   156) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   157,   162) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   163,   168) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   169,   174) /     1,     2,     0,    
     $  0,     3,     3/
      DATA (CONFIG_MAP(I),I=   175,   180) /     0,     0,     2,    
     $  0,     1,     0/
      DATA (CONFIG_MAP(I),I=   181,   186) /     4,     4,     5,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   187,   192) /     0,     5,     0,    
     $  0,     6,     6/
      DATA (CONFIG_MAP(I),I=   193,   198) /     7,     7,     8,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   199,   204) /     0,     8,     0,    
     $  0,     9,     9/
      DATA (CONFIG_MAP(I),I=   205,   210) /    10,     0,     0,    
     $  0,    10,     0/
      DATA (CONFIG_MAP(I),I=   211,   216) /     0,     0,    11,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   217,   222) /    11,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   223,   228) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   229,   234) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   235,   240) /     0,    12,     0,    
     $  0,    12,     0/
      DATA (CONFIG_MAP(I),I=   241,   246) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   247,   252) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   253,   258) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   259,   264) /    13,    13,    14,   
     $  14,    15,    15/
      DATA (CONFIG_MAP(I),I=   265,   270) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   271,   276) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   277,   282) /     0,     0,     0,    
     $  0,     0,     0/
...
C     
     ...
     $ ,    13,    15,    23/
      DATA (CONFIG_INDEX_MAP(I),I=     7,    12) /    25,    27,    35
     $ ,    37,    45,    68/
      DATA (CONFIG_INDEX_MAP(I),I=    13,    15) /    87,    89,    91/
C     
C     ARGUMENTS
C     
      INTEGER HEL_MULT
