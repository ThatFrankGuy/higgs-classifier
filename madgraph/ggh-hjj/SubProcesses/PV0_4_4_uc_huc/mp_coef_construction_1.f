      SUBROUTINE ML5_0_4_4_MP_COEF_CONSTRUCTION_1(P,NHEL,H,IC)
C     
...
C     
      ...
      COMMON/ML5_0_4_4_FILTERS/GOODAMP,GOODHEL
...
C     Coefficient construction for loop diagram with ID 1
      ...
      CALL MP_ML5_0_4_4_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1
     $ ,1))
      CALL MP_FFV1L1_2(PL(0,1),W(1,6),GC_5,MDL_MB,ZERO,PL(0,2),COEFS)
      CALL MP_ML5_0_4_4_UPDATE_WL_1_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1
     $ ,2))
      CALL MP_FFV1L1_2(PL(0,2),W(1,7),GC_5,MDL_MB,ZERO,PL(0,3),COEFS)
      CALL MP_ML5_0_4_4_UPDATE_WL_2_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1
     $ ,3))
      CALL MP_ML5_0_4_4_CREATE_LOOP_COEFS(WL(1,0,1,3),3,4,1,1,1,3)
C     Coefficient construction for loop diagram with ID 2
     ...
     $ ,4))
      ...
      CALL MP_ML5_0_4_4_UPDATE_WL_1_1(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1
     $ ,5))
      CALL MP_FFV1L2_1(PL(0,5),W(1,7),GC_5,MDL_MB,ZERO,PL(0,6),COEFS)
      CALL MP_ML5_0_4_4_UPDATE_WL_2_1(WL(1,0,1,5),4,COEFS,4,4,WL(1,0,1
     $ ,6))
      CALL MP_ML5_0_4_4_CREATE_LOOP_COEFS(WL(1,0,1,6),3,4,2,1,1,4)
C     Coefficient construction for loop diagram with ID 3
     ...
     $ ,7))
      ...
      CALL MP_ML5_0_4_4_UPDATE_WL_1_1(WL(1,0,1,7),4,COEFS,4,4,WL(1,0,1
     $ ,8))
      CALL MP_FFV1L1_2(PL(0,8),W(1,7),GC_5,MDL_MT,MDL_WT,PL(0,9),COEFS)
      CALL MP_ML5_0_4_4_UPDATE_WL_2_1(WL(1,0,1,8),4,COEFS,4,4,WL(1,0,1
     $ ,9))
      CALL MP_ML5_0_4_4_CREATE_LOOP_COEFS(WL(1,0,1,9),3,4,3,1,1,5)
C     Coefficient construction for loop diagram with ID 4
     ...
     $ ,COEFS)
      CALL MP_ML5_0_4_4_UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0
     $ ,1,11))
      CALL MP_FFV1L2_1(PL(0,11),W(1,7),GC_5,MDL_MT,MDL_WT,PL(0,12)
     $ ,COEFS)
      CALL MP_ML5_0_4_4_UPDATE_WL_2_1(WL(1,0,1,11),4,COEFS,4,4,WL(1,0
     $ ,1,12))
      CALL MP_ML5_0_4_4_CREATE_LOOP_COEFS(WL(1,0,1,12),3,4,4,1,1,6)
