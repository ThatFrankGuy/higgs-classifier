...
matrix2py.ml5_0_4_4_initialise(os.path.abspath(pjoin(root_path,os.pardir,os.pardir,'Cards','param_card.dat')))
...
finite_loop_me, return_code = matrix2py.ml5_0_4_4_get_me(P, alphas, renormalization_scale, nhel)


print '='*112
print '* %-108s *'%' MadLoop evaluation for the process '
print '* %-108s *'%'   u c > h u c QED<=2 [ noborn = QCD ]'
