      SUBROUTINE ML5_0_1_1_LOOP_CT_CALLS_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     CutTools call for loop # 38
      CALL ML5_0_1_1_LOOP_4(1,3,2,7,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),DCMPLX(MDL_MT),4,I_SO,38)
C     CutTools call for loop # 39
      CALL ML5_0_1_1_LOOP_3(2,3,17,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
