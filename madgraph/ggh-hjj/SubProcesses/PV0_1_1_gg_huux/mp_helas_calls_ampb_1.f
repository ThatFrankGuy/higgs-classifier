      SUBROUTINE ML5_0_1_1_MP_HELAS_CALLS_AMPB_1(P,NHEL,H,IC)
C     
...
C      if true.
      ...
      CALL MP_FFV1P0_3(W(1,5),W(1,4),GC_5,ZERO,ZERO,W(1,7))
C     Counter-term amplitude(s) for loop diagram number 1
      CALL MP_VVS1_0(W(1,6),W(1,7),W(1,3),R2_GGHB,AMPL(1,1))
      CALL MP_FFV1_1(W(1,4),W(1,1),GC_5,ZERO,ZERO,W(1,8))
      CALL MP_FFV1P0_3(W(1,5),W(1,8),GC_5,ZERO,ZERO,W(1,9))
C     Counter-term amplitude(s) for loop diagram number 3
      CALL MP_VVS1_0(W(1,2),W(1,9),W(1,3),R2_GGHB,AMPL(1,2))
      CALL MP_FFV1_2(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,10))
      CALL MP_FFV1P0_3(W(1,10),W(1,4),GC_5,ZERO,ZERO,W(1,11))
C     Counter-term amplitude(s) for loop diagram number 5
      CALL MP_VVS1_0(W(1,2),W(1,11),W(1,3),R2_GGHB,AMPL(1,3))
      CALL MP_FFV1_1(W(1,4),W(1,2),GC_5,ZERO,ZERO,W(1,12))
      CALL MP_FFV1P0_3(W(1,5),W(1,12),GC_5,ZERO,ZERO,W(1,13))
C     Counter-term amplitude(s) for loop diagram number 7
      CALL MP_VVS1_0(W(1,1),W(1,13),W(1,3),R2_GGHB,AMPL(1,4))
      CALL MP_FFV1_2(W(1,5),W(1,2),GC_5,ZERO,ZERO,W(1,14))
      CALL MP_FFV1P0_3(W(1,14),W(1,4),GC_5,ZERO,ZERO,W(1,15))
C     Counter-term amplitude(s) for loop diagram number 9
      CALL MP_VVS1_0(W(1,1),W(1,15),W(1,3),R2_GGHB,AMPL(1,5))
      CALL MP_VVV1P0_1(W(1,2),W(1,7),GC_4,ZERO,ZERO,W(1,16))
C     Counter-term amplitude(s) for loop diagram number 14
      CALL MP_VVS1_0(W(1,1),W(1,16),W(1,3),R2_GGHB,AMPL(1,6))
      CALL MP_VVV1P0_1(W(1,1),W(1,7),GC_4,ZERO,ZERO,W(1,17))
C     Counter-term amplitude(s) for loop diagram number 19
      CALL MP_VVS1_0(W(1,2),W(1,17),W(1,3),R2_GGHB,AMPL(1,7))
C     Counter-term amplitude(s) for loop diagram number 21
      CALL MP_VVS1_0(W(1,6),W(1,7),W(1,3),R2_GGHT,AMPL(1,8))
C     Counter-term amplitude(s) for loop diagram number 23
      CALL MP_VVS1_0(W(1,2),W(1,9),W(1,3),R2_GGHT,AMPL(1,9))
C     Counter-term amplitude(s) for loop diagram number 25
      CALL MP_VVS1_0(W(1,2),W(1,11),W(1,3),R2_GGHT,AMPL(1,10))
...
C     Counter-term amplitude(s) for loop diagram number 29
      CALL MP_VVS1_0(W(1,1),W(1,15),W(1,3),R2_GGHT,AMPL(1,12))
...
C     Counter-term amplitude(s) for loop diagram number 39
      CALL MP_VVS1_0(W(1,2),W(1,17),W(1,3),R2_GGHT,AMPL(1,14))
