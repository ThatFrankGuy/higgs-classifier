      SUBROUTINE ML5_0_2_2_COEF_CONSTRUCTION_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     Coefficient construction for loop diagram with ID 1
      ...
      CALL ML5_0_2_2_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,1))
      CALL FFV1L2_1(PL(0,1),W(1,4),GC_5,MDL_MB,ZERO,PL(0,2),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_1_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,2))
      CALL FFV1L2_1(PL(0,2),W(1,7),GC_5,MDL_MB,ZERO,PL(0,3),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,3))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,3),3,4,1,1,1,15)
C     Coefficient construction for loop diagram with ID 2
      CALL FFS1L1_2(PL(0,0),W(1,3),GC_33,MDL_MB,ZERO,PL(0,4),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,4))
      CALL FFV1L1_2(PL(0,4),W(1,4),GC_5,MDL_MB,ZERO,PL(0,5),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_1_1(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1,5))
      CALL FFV1L1_2(PL(0,5),W(1,7),GC_5,MDL_MB,ZERO,PL(0,6),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,5),4,COEFS,4,4,WL(1,0,1,6))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,6),3,4,2,1,1,16)
C     Coefficient construction for loop diagram with ID 3
      CALL FFV1L1_2(PL(0,4),W(1,8),GC_5,MDL_MB,ZERO,PL(0,7),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_1_1(WL(1,0,1,4),4,COEFS,4,4,WL(1,0,1,7))
      CALL FFV1L1_2(PL(0,7),W(1,9),GC_5,MDL_MB,ZERO,PL(0,8),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,7),4,COEFS,4,4,WL(1,0,1,8))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,8),3,4,3,1,1,17)
C     Coefficient construction for loop diagram with ID 4
      CALL FFV1L2_1(PL(0,1),W(1,8),GC_5,MDL_MB,ZERO,PL(0,9),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_1_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,9))
      CALL FFV1L2_1(PL(0,9),W(1,9),GC_5,MDL_MB,ZERO,PL(0,10),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,9),4,COEFS,4,4,WL(1,0,1,10)
     $ )
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,10),3,4,4,1,1,18)
C     Coefficient construction for loop diagram with ID 5
      CALL FFV1L2_1(PL(0,2),W(1,11),GC_5,MDL_MB,ZERO,PL(0,11),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,11)
     $ )
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,11),3,4,5,1,1,19)
C     Coefficient construction for loop diagram with ID 6
      CALL FFV1L1_2(PL(0,5),W(1,11),GC_5,MDL_MB,ZERO,PL(0,12),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,5),4,COEFS,4,4,WL(1,0,1,12)
     $ )
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,12),3,4,6,1,1,20)
C     Coefficient construction for loop diagram with ID 7
      CALL FFV1L2_1(PL(0,0),W(1,1),GC_5,MDL_MB,ZERO,PL(0,13),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,13)
     $ )
      CALL FFS1L2_1(PL(0,13),W(1,3),GC_33,MDL_MB,ZERO,PL(0,14),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_1_1(WL(1,0,1,13),4,COEFS,4,4,WL(1,0,1
     $ ,14))
      CALL FFV1L2_1(PL(0,14),W(1,13),GC_5,MDL_MB,ZERO,PL(0,15),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,14),4,COEFS,4,4,WL(1,0,1
     $ ,15))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,15),3,4,7,1,1,21)
C     Coefficient construction for loop diagram with ID 8
      CALL FFV1L1_2(PL(0,0),W(1,1),GC_5,MDL_MB,ZERO,PL(0,16),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,16)
     $ )
      CALL FFS1L1_2(PL(0,16),W(1,3),GC_33,MDL_MB,ZERO,PL(0,17),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_1_1(WL(1,0,1,16),4,COEFS,4,4,WL(1,0,1
     $ ,17))
      CALL FFV1L1_2(PL(0,17),W(1,13),GC_5,MDL_MB,ZERO,PL(0,18),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1
     $ ,18))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,18),3,4,8,1,1,22)
C     Coefficient construction for loop diagram with ID 9
      CALL FFV1L2_1(PL(0,14),W(1,14),GC_5,MDL_MB,ZERO,PL(0,19),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,14),4,COEFS,4,4,WL(1,0,1
     $ ,19))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,19),3,4,9,1,1,23)
C     Coefficient construction for loop diagram with ID 10
     ...
     $ ,20))
      ...
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,20),4,COEFS,4,4,WL(1,0,1
     $ ,21))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,21),4,4,10,1,1,24)
C     Coefficient construction for loop diagram with ID 11
     ...
     $ ,22))
      ...
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,22),4,COEFS,4,4,WL(1,0,1
     $ ,23))
      CALL FFV1L2_1(PL(0,23),W(1,9),GC_5,MDL_MB,ZERO,PL(0,24),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,23),4,COEFS,4,4,WL(1,0,1
     $ ,24))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,24),4,4,11,1,1,25)
C     Coefficient construction for loop diagram with ID 12
     ...
     $ ,25))
      ...
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,25),4,COEFS,4,4,WL(1,0,1
     $ ,26))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,26),4,4,12,1,1,26)
C     Coefficient construction for loop diagram with ID 13
      CALL FFV1L1_2(PL(0,17),W(1,14),GC_5,MDL_MB,ZERO,PL(0,27),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1
     $ ,27))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,27),3,4,13,1,1,27)
C     Coefficient construction for loop diagram with ID 14
     ...
     $ ,28))
      ...
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,28),4,COEFS,4,4,WL(1,0,1
     $ ,29))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,29),4,4,14,1,1,28)
C     Coefficient construction for loop diagram with ID 15
     ...
     $ ,30))
      ...
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,30),4,COEFS,4,4,WL(1,0,1
     $ ,31))
      CALL FFV1L1_2(PL(0,31),W(1,9),GC_5,MDL_MB,ZERO,PL(0,32),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,31),4,COEFS,4,4,WL(1,0,1
     $ ,32))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,32),4,4,15,1,1,29)
C     Coefficient construction for loop diagram with ID 16
     ...
     $ ,33))
      ...
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,33),4,COEFS,4,4,WL(1,0,1
     $ ,34))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,34),4,4,16,1,1,30)
C     Coefficient construction for loop diagram with ID 17
      CALL FFV1L1_2(PL(0,17),W(1,16),GC_5,MDL_MB,ZERO,PL(0,35),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1
     $ ,35))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,35),3,4,17,1,1,31)
C     Coefficient construction for loop diagram with ID 18
      CALL FFV1L2_1(PL(0,14),W(1,16),GC_5,MDL_MB,ZERO,PL(0,36),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,14),4,COEFS,4,4,WL(1,0,1
     $ ,36))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,36),3,4,18,1,1,32)
C     Coefficient construction for loop diagram with ID 19
      CALL FFV1L2_1(PL(0,2),W(1,17),GC_5,MDL_MB,ZERO,PL(0,37),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,37)
     $ )
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,37),3,4,19,1,1,33)
C     Coefficient construction for loop diagram with ID 20
      CALL FFV1L1_2(PL(0,5),W(1,17),GC_5,MDL_MB,ZERO,PL(0,38),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,5),4,COEFS,4,4,WL(1,0,1,38)
     $ )
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,38),3,4,20,1,1,34)
C     Coefficient construction for loop diagram with ID 21
      CALL FFS1L2_1(PL(0,0),W(1,3),GC_37,MDL_MT,MDL_WT,PL(0,39),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,39)
     $ )
      CALL FFV1L2_1(PL(0,39),W(1,4),GC_5,MDL_MT,MDL_WT,PL(0,40),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_1_1(WL(1,0,1,39),4,COEFS,4,4,WL(1,0,1
     $ ,40))
      CALL FFV1L2_1(PL(0,40),W(1,7),GC_5,MDL_MT,MDL_WT,PL(0,41),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,40),4,COEFS,4,4,WL(1,0,1
     $ ,41))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,41),3,4,21,1,1,35)
C     Coefficient construction for loop diagram with ID 22
      CALL FFS1L1_2(PL(0,0),W(1,3),GC_37,MDL_MT,MDL_WT,PL(0,42),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,42)
     $ )
      CALL FFV1L1_2(PL(0,42),W(1,4),GC_5,MDL_MT,MDL_WT,PL(0,43),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_1_1(WL(1,0,1,42),4,COEFS,4,4,WL(1,0,1
     $ ,43))
      CALL FFV1L1_2(PL(0,43),W(1,7),GC_5,MDL_MT,MDL_WT,PL(0,44),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,43),4,COEFS,4,4,WL(1,0,1
     $ ,44))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,44),3,4,22,1,1,36)
C     Coefficient construction for loop diagram with ID 23
     ...
     $ ,45))
      ...
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,45),4,COEFS,4,4,WL(1,0,1
     $ ,46))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,46),3,4,23,1,1,37)
...
C     Coefficient construction for loop diagram with ID 30
     ...
     $ ,58))
      ...
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,58),4,COEFS,4,4,WL(1,0,1
     $ ,59))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,59),4,4,30,1,1,44)
C     Coefficient construction for loop diagram with ID 31
     ...
     $ ,60))
      ...
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,60),4,COEFS,4,4,WL(1,0,1
     $ ,61))
      CALL FFV1L2_1(PL(0,61),W(1,9),GC_5,MDL_MT,MDL_WT,PL(0,62),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,61),4,COEFS,4,4,WL(1,0,1
     $ ,62))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,62),4,4,31,1,1,45)
C     Coefficient construction for loop diagram with ID 32
     ...
     $ ,63))
      ...
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,63),4,COEFS,4,4,WL(1,0,1
     $ ,64))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,64),4,4,32,1,1,46)
C     Coefficient construction for loop diagram with ID 33
      CALL FFV1L1_2(PL(0,55),W(1,14),GC_5,MDL_MT,MDL_WT,PL(0,65),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,55),4,COEFS,4,4,WL(1,0,1
     $ ,65))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,65),3,4,33,1,1,47)
C     Coefficient construction for loop diagram with ID 34
     ...
     $ ,66))
      ...
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,66),4,COEFS,4,4,WL(1,0,1
     $ ,67))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,67),4,4,34,1,1,48)
C     Coefficient construction for loop diagram with ID 35
     ...
     $ ,68))
      ...
      CALL ML5_0_2_2_UPDATE_WL_2_1(WL(1,0,1,68),4,COEFS,4,4,WL(1,0,1
     $ ,69))
      CALL FFV1L1_2(PL(0,69),W(1,9),GC_5,MDL_MT,MDL_WT,PL(0,70),COEFS)
      CALL ML5_0_2_2_UPDATE_WL_3_1(WL(1,0,1,69),4,COEFS,4,4,WL(1,0,1
     $ ,70))
      CALL ML5_0_2_2_CREATE_LOOP_COEFS(WL(1,0,1,70),4,4,35,1,1,49)
