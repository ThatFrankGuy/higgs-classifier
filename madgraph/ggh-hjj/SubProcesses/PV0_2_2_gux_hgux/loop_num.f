...
C      CALLS BUILDING THE LOOP
      ...
      SUBROUTINE ML5_0_2_2_LOOPNUM(Q,RES)
C     
C     CONSTANTS 
C     
      INTEGER    NLOOPGROUPS
...
C     
      ...
      CALL ML5_0_2_2_EVAL_POLY(LOOPCOEFS(0,ID),RANK,-Q,RES)
      END

      SUBROUTINE ML5_0_2_2_MPLOOPNUM(Q,RES)
C     
C     MODULE
C     
      INCLUDE 'cts_mprec.h'
...
C      PURPOSE
      ...
      COMMON/ML5_0_2_2_MP_PSPOINT/MP_PS,MP_P
...
C     ----------
      ...
      CALL MP_ML5_0_2_2_EVAL_POLY(LOOPCOEFS(0,ID),RANK,-QQ,QRES)
      RES=QRES

      END

      SUBROUTINE ML5_0_2_2_MPLOOPNUM_DUMMY(Q,RES)
C     
C     MODULE
C     
      INCLUDE 'cts_mprec.h'
...
C     ----------
      ...
      CALL ML5_0_2_2_LOOPNUM(DQ,DRES)
      RES=DRES
