      SUBROUTINE ML5_0_2_2_HELAS_CALLS_AMPB_1(P,NHEL,H,IC)
C     
C     Modules
C     
...
C     
      ...
      COMMON/ML5_0_2_2_FILTERS/GOODAMP,GOODHEL,HELOFFSET

      LOGICAL CHECKPHASE
      LOGICAL HELDOUBLECHECKED
      COMMON/ML5_0_2_2_INIT/CHECKPHASE, HELDOUBLECHECKED
     ...
     $ ,MP_LOOP_REQ_SO_DONE,CTCALL_REQ_SO_DONE,FILTER_SO
      ...
      INTEGER I_SO
      COMMON/ML5_0_2_2_I_SO/I_SO
      INTEGER I_LIB
      COMMON/ML5_0_2_2_I_LIB/I_LIB

      COMPLEX*16 W(20,NWAVEFUNCS)
      COMMON/ML5_0_2_2_W/W

      COMPLEX*16 WL(MAXLWFSIZE,0:LOOPMAXCOEFS-1,MAXLWFSIZE,
     $ -1:NLOOPWAVEFUNCS)
      COMPLEX*16 PL(0:3,-1:NLOOPWAVEFUNCS)
      COMMON/ML5_0_2_2_WL/WL,PL
...
C      if true.
      ...
      CALL FFV1P0_3(W(1,5),W(1,6),GC_5,ZERO,ZERO,W(1,7))
C     Counter-term amplitude(s) for loop diagram number 1
      CALL VVS1_0(W(1,4),W(1,7),W(1,3),R2_GGHB,AMPL(1,1))
      CALL VVV1P0_1(W(1,1),W(1,4),GC_4,ZERO,ZERO,W(1,8))
      CALL FFV1P0_3(W(1,5),W(1,2),GC_5,ZERO,ZERO,W(1,9))
C     Counter-term amplitude(s) for loop diagram number 3
      CALL VVS1_0(W(1,8),W(1,9),W(1,3),R2_GGHB,AMPL(1,2))
      CALL FFV1_2(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,10),W(1,2),GC_5,ZERO,ZERO,W(1,11))
C     Counter-term amplitude(s) for loop diagram number 5
      CALL VVS1_0(W(1,4),W(1,11),W(1,3),R2_GGHB,AMPL(1,3))
      CALL FFV1_1(W(1,2),W(1,4),GC_5,ZERO,ZERO,W(1,12))
      CALL FFV1P0_3(W(1,5),W(1,12),GC_5,ZERO,ZERO,W(1,13))
C     Counter-term amplitude(s) for loop diagram number 7
      CALL VVS1_0(W(1,1),W(1,13),W(1,3),R2_GGHB,AMPL(1,4))
      CALL VVV1P0_1(W(1,4),W(1,9),GC_4,ZERO,ZERO,W(1,14))
C     Counter-term amplitude(s) for loop diagram number 9
      CALL VVS1_0(W(1,1),W(1,14),W(1,3),R2_GGHB,AMPL(1,5))
      CALL FFV1_2(W(1,5),W(1,4),GC_5,ZERO,ZERO,W(1,15))
      CALL FFV1P0_3(W(1,15),W(1,2),GC_5,ZERO,ZERO,W(1,16))
C     Counter-term amplitude(s) for loop diagram number 17
      CALL VVS1_0(W(1,1),W(1,16),W(1,3),R2_GGHB,AMPL(1,6))
      CALL VVV1P0_1(W(1,1),W(1,9),GC_4,ZERO,ZERO,W(1,17))
...
C     Counter-term amplitude(s) for loop diagram number 21
      CALL VVS1_0(W(1,4),W(1,7),W(1,3),R2_GGHT,AMPL(1,8))
C     Counter-term amplitude(s) for loop diagram number 23
      CALL VVS1_0(W(1,8),W(1,9),W(1,3),R2_GGHT,AMPL(1,9))
C     Counter-term amplitude(s) for loop diagram number 25
      CALL VVS1_0(W(1,4),W(1,11),W(1,3),R2_GGHT,AMPL(1,10))
...
C     Counter-term amplitude(s) for loop diagram number 29
      CALL VVS1_0(W(1,1),W(1,14),W(1,3),R2_GGHT,AMPL(1,12))
