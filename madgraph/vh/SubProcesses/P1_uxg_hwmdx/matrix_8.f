...
C     
C     Process: u~ s > h w- s d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: u~ c > h w- c d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ d > h w- d s~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ u > h w- u s~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL VVS1_2(W(1,4),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,5))
