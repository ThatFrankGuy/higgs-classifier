...
C     
C     Process: d d > h z d d WEIGHTED<=6 [ all = QCD ] @1
C     Process: s s > h z s s WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,4),W(1,6),W(1,8),-GC_22,GC_23,AMP(1))
      CALL FFV1_1(W(1,6),W(1,7),GC_5,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,2),W(1,4),W(1,8),-GC_22,GC_23,AMP(2))
      CALL FFV1P0_3(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,4))
      CALL FFV1_2(W(1,2),W(1,4),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,7),W(1,5),W(1,8),-GC_22,GC_23,AMP(3))
      CALL FFV1_1(W(1,5),W(1,4),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,2),W(1,7),W(1,8),-GC_22,GC_23,AMP(4))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_5,ZERO,ZERO,W(1,7))
      CALL FFV1_2(W(1,1),W(1,7),GC_5,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,4),W(1,6),W(1,8),-GC_22,GC_23,AMP(5))
      CALL FFV2_3_2(W(1,1),W(1,8),-GC_22,GC_23,ZERO,ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 7
      CALL FFV2_3_0(W(1,6),W(1,5),W(1,8),-GC_22,GC_23,AMP(7))
