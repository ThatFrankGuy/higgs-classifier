...
C      if true.
      ...
      CALL MP_FFV2_3(W(1,2),W(1,1),GC_47,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for born diagram with ID 1
      CALL MP_VVS1_0(W(1,4),W(1,5),W(1,3),GC_31,AMP(1))
      CALL MP_VVS1_2(W(1,4),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,6))
C     Counter-term amplitude(s) for loop diagram number 2
      CALL MP_FFV2_0(W(1,2),W(1,1),W(1,6),R2_SXCW,AMPL(1,1))
