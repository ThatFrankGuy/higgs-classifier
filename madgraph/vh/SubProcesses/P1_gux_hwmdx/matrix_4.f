...
C     
C     Process: u~ u~ > h w- d~ u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ c~ > h w- s~ c~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,2),W(1,8),GC_47,AMP(2))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_5,ZERO,ZERO,W(1,4))
      CALL FFV1_1(W(1,1),W(1,4),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,6),W(1,8),GC_47,AMP(3))
      CALL FFV2_1(W(1,1),W(1,8),GC_47,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,5),W(1,6),W(1,4),GC_5,AMP(4))
      JAMP(1)=+1D0/2D0*(+AMP(1)+AMP(2)+1D0/3D0*AMP(3)+1D0/3D0*AMP(4))
      JAMP(2)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-AMP(3)-AMP(4))
      MATRIX_4 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
