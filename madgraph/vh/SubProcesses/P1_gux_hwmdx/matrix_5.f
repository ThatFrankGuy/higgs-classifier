...
C     
C     Process: u u~ > h w- u d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c c~ > h w- c s~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,2),W(1,4),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,6),W(1,5),W(1,8),GC_47,AMP(3))
      CALL FFV1_2(W(1,6),W(1,4),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,8),GC_47,AMP(4))
