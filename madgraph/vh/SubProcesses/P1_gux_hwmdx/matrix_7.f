...
C     
C     Process: s u~ > h w- s d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c u~ > h w- c d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: d c~ > h w- d s~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: u c~ > h w- u s~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
