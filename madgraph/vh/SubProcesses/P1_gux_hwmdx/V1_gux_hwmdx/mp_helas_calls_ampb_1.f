...
C     Counter-term amplitude(s) for loop diagram number 6
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),UV_GQQQ_1EPS,AMPL(2,4))
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),UV_GQQQ_1EPS,AMPL(2,5))
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),UV_GQQQ_1EPS,AMPL(2,6))
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),UV_GQQQ_1EPS,AMPL(2,7))
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),UV_GQQB,AMPL(1,8))
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),UV_GQQQ_1EPS,AMPL(2,9))
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),UV_GQQT,AMPL(1,10))
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),UV_GQQQ_1EPS,AMPL(2,11))
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),UV_GQQG_1EPS,AMPL(2,12))
      CALL MP_FFV1_0(W(1,5),W(1,9),W(1,1),R2_GQQ,AMPL(1,13))
...
C     Counter-term amplitude(s) for loop diagram number 12
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),UV_GQQQ_1EPS,AMPL(2,15))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),UV_GQQQ_1EPS,AMPL(2,16))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),UV_GQQQ_1EPS,AMPL(2,17))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),UV_GQQQ_1EPS,AMPL(2,18))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),UV_GQQB,AMPL(1,19))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),UV_GQQQ_1EPS,AMPL(2,20))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),UV_GQQT,AMPL(1,21))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),UV_GQQQ_1EPS,AMPL(2,22))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),UV_GQQG_1EPS,AMPL(2,23))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,1),R2_GQQ,AMPL(1,24))
