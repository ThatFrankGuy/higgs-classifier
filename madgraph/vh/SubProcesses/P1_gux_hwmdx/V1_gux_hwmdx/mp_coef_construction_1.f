...
C     Coefficient construction for loop diagram with ID 6
      CALL MP_FFV1L2_1(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,9),COEFS)
...
C     Coefficient construction for loop diagram with ID 7
      CALL MP_FFV1L3_1(PL(0,10),W(1,2),GC_5,ZERO,ZERO,PL(0,12),COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1,12))
      CALL MP_FFV2L2_1(PL(0,12),W(1,7),GC_47,ZERO,ZERO,PL(0,13),COEFS)
      CALL MP_UPDATE_WL_2_1(WL(1,0,1,12),4,COEFS,4,4,WL(1,0,1,13))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,13),3,4,5,1,1,37,H)
C     Coefficient construction for loop diagram with ID 8
      ...
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,16),2,4,4,1,1,38,H)
C     Coefficient construction for loop diagram with ID 9
      CALL MP_FFV1L3_1(PL(0,14),W(1,2),GC_5,ZERO,ZERO,PL(0,17),COEFS)
      ...
      CALL MP_UPDATE_WL_3_0(WL(1,0,1,18),4,COEFS,4,4,WL(1,0,1,19))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,19),3,4,6,1,1,39,H)
C     Coefficient construction for loop diagram with ID 10
      CALL MP_FFV1L1_2(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,20),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,20))
      CALL MP_FFV1L1P0_3(PL(0,20),W(1,2),GC_5,ZERO,ZERO,PL(0,21),COEFS)
      CALL MP_UPDATE_WL_1_0(WL(1,0,1,20),4,COEFS,4,4,WL(1,0,1,21))
      CALL MP_FFV1L3_2(PL(0,21),W(1,5),GC_5,ZERO,ZERO,PL(0,22),COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,22))
      CALL MP_FFV2L1_2(PL(0,22),W(1,7),GC_47,ZERO,ZERO,PL(0,23),COEFS)
      CALL MP_UPDATE_WL_2_1(WL(1,0,1,22),4,COEFS,4,4,WL(1,0,1,23))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,23),3,4,7,1,1,40,H)
C     Coefficient construction for loop diagram with ID 11
      CALL MP_FFV1L1P0_3(PL(0,0),W(1,6),GC_5,ZERO,ZERO,PL(0,24),COEFS)
      CALL MP_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,24))
      CALL MP_FFV1L3_2(PL(0,24),W(1,10),GC_5,ZERO,ZERO,PL(0,25),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1,25))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,25),1,4,8,1,1,41,H)
C     Coefficient construction for loop diagram with ID 12
      CALL MP_FFV1L3_2(PL(0,21),W(1,10),GC_5,ZERO,ZERO,PL(0,26),COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,26))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,26),2,4,9,1,1,42,H)
C     Coefficient construction for loop diagram with ID 13
      CALL MP_FFV1L2P0_3(PL(0,17),W(1,10),GC_5,ZERO,ZERO,PL(0,27)
     $ ,COEFS)
      CALL MP_UPDATE_WL_2_0(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,27))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,27),2,4,9,1,1,43,H)
C     Coefficient construction for loop diagram with ID 14
      CALL MP_FFV1L2_1(PL(0,0),W(1,1),GC_5,MDL_MB,ZERO,PL(0,28),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,28))
      CALL MP_FFS1L2_1(PL(0,28),W(1,3),GC_33,MDL_MB,ZERO,PL(0,29)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 15
      CALL MP_FFV1L1_2(PL(0,0),W(1,1),GC_5,MDL_MB,ZERO,PL(0,31),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,31))
      CALL MP_FFS1L1_2(PL(0,31),W(1,3),GC_33,MDL_MB,ZERO,PL(0,32)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 16
      CALL MP_FFV1L1_2(PL(0,32),W(1,14),GC_5,MDL_MB,ZERO,PL(0,34)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 17
      CALL MP_FFV1L2_1(PL(0,29),W(1,14),GC_5,MDL_MB,ZERO,PL(0,35)
     $ ,COEFS)
      CALL MP_UPDATE_WL_2_1(WL(1,0,1,29),4,COEFS,4,4,WL(1,0,1,35))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,35),3,4,10,1,1,47,H)
C     Coefficient construction for loop diagram with ID 18
      CALL MP_FFV1L2_1(PL(0,0),W(1,1),GC_5,MDL_MT,MDL_WT,PL(0,36)
     $ ,COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,36))
      CALL MP_FFS1L2_1(PL(0,36),W(1,3),GC_37,MDL_MT,MDL_WT,PL(0,37)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 19
      CALL MP_FFV1L1_2(PL(0,0),W(1,1),GC_5,MDL_MT,MDL_WT,PL(0,39)
     $ ,COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,39))
      CALL MP_FFS1L1_2(PL(0,39),W(1,3),GC_37,MDL_MT,MDL_WT,PL(0,40)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 20
      CALL MP_FFV1L1_2(PL(0,40),W(1,14),GC_5,MDL_MT,MDL_WT,PL(0,42)
     $ ,COEFS)
      CALL MP_UPDATE_WL_2_1(WL(1,0,1,40),4,COEFS,4,4,WL(1,0,1,42))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,42),3,4,11,1,1,50,H)
C     Coefficient construction for loop diagram with ID 21
      CALL MP_FFV1L2_1(PL(0,37),W(1,14),GC_5,MDL_MT,MDL_WT,PL(0,43)
     $ ,COEFS)
      CALL MP_UPDATE_WL_2_1(WL(1,0,1,37),4,COEFS,4,4,WL(1,0,1,43))
