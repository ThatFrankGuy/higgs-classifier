...
C     Coefficient construction for loop diagram with ID 7
      CALL FFV1L3_1(PL(0,10),W(1,2),GC_5,ZERO,ZERO,PL(0,12),COEFS)
...
C     Coefficient construction for loop diagram with ID 9
      CALL FFV1L3_1(PL(0,14),W(1,2),GC_5,ZERO,ZERO,PL(0,17),COEFS)
...
C     Coefficient construction for loop diagram with ID 10
      CALL FFV1L1_2(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,20),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,20))
      CALL FFV1L1P0_3(PL(0,20),W(1,2),GC_5,ZERO,ZERO,PL(0,21),COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,20),4,COEFS,4,4,WL(1,0,1,21))
      CALL FFV1L3_2(PL(0,21),W(1,5),GC_5,ZERO,ZERO,PL(0,22),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,22))
      CALL FFV2L1_2(PL(0,22),W(1,7),GC_47,ZERO,ZERO,PL(0,23),COEFS)
...
C     Coefficient construction for loop diagram with ID 11
      CALL FFV1L1P0_3(PL(0,0),W(1,6),GC_5,ZERO,ZERO,PL(0,24),COEFS)
...
C     Coefficient construction for loop diagram with ID 12
      CALL FFV1L3_2(PL(0,21),W(1,10),GC_5,ZERO,ZERO,PL(0,26),COEFS)
...
C     Coefficient construction for loop diagram with ID 13
      CALL FFV1L2P0_3(PL(0,17),W(1,10),GC_5,ZERO,ZERO,PL(0,27),COEFS)
