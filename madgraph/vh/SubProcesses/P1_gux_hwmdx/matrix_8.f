...
C     
C     Process: g g > h w- u d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: g g > h w- c s~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
