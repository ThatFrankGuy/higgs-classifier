...
C     Coefficient construction for loop diagram with ID 7
      CALL FFV1L3_2(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,12),COEFS)
...
C     Coefficient construction for loop diagram with ID 8
      CALL FFV1L1P0_3(PL(0,0),W(1,8),GC_5,ZERO,ZERO,PL(0,15),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,15))
      CALL FFV1L3_2(PL(0,15),W(1,11),GC_5,ZERO,ZERO,PL(0,16),COEFS)
...
C     Coefficient construction for loop diagram with ID 11
      CALL FFV1L2P0_3(PL(0,20),W(1,2),GC_5,ZERO,ZERO,PL(0,23),COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,20),4,COEFS,4,4,WL(1,0,1,23))
...
C     Coefficient construction for loop diagram with ID 12
      CALL FFV1L3_1(PL(0,23),W(1,5),GC_5,ZERO,ZERO,PL(0,25),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,23),4,COEFS,4,4,WL(1,0,1,25))
      CALL FFV2_5L2_1(PL(0,25),W(1,7),GC_22,GC_23,ZERO,ZERO,PL(0,26)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 13
      CALL FFV1L1P0_3(PL(0,17),W(1,5),GC_5,ZERO,ZERO,PL(0,27),COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,27))
      CALL FFV1L3_2(PL(0,27),W(1,2),GC_5,ZERO,ZERO,PL(0,28),COEFS)
     ...
     $ ,COEFS)
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,29),3,4,8,1,1,49,H)
C     Coefficient construction for loop diagram with ID 14
      CALL FFV1L3_2(PL(0,27),W(1,11),GC_5,ZERO,ZERO,PL(0,30),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,27),4,COEFS,4,4,WL(1,0,1,30))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,30),2,4,9,1,1,50,H)
C     Coefficient construction for loop diagram with ID 15
      ...
      CALL FFV1L3_2(PL(0,31),W(1,2),GC_5,ZERO,ZERO,PL(0,32),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,31),4,COEFS,4,4,WL(1,0,1,32))
      CALL FFV1L1P0_3(PL(0,32),W(1,10),GC_5,ZERO,ZERO,PL(0,33),COEFS)
...
C     Coefficient construction for loop diagram with ID 16
      CALL FFV2_5L1_2(PL(0,32),W(1,7),GC_22,GC_23,ZERO,ZERO,PL(0,34)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 17
      CALL FFV1L3_1(PL(0,31),W(1,5),GC_5,ZERO,ZERO,PL(0,36),COEFS)
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,37),2,4,9,1,1,53,H)
