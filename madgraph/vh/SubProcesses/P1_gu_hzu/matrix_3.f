...
C     
C     Process: d u > h z u d WEIGHTED<=6 [ all = QCD ] @1
C     Process: s u > h z u s WEIGHTED<=6 [ all = QCD ] @1
C     Process: d c > h z c d WEIGHTED<=6 [ all = QCD ] @1
C     Process: s c > h z c s WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,2),W(1,5),GC_5,ZERO,ZERO,W(1,4))
      CALL FFV1_2(W(1,1),W(1,4),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,5),W(1,6),W(1,8),-GC_22,GC_23,AMP(3))
      CALL FFV2_3_2(W(1,1),W(1,8),-GC_22,GC_23,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,5),W(1,6),W(1,4),GC_5,AMP(4))
      JAMP(1)=+1D0/2D0*(+AMP(1)+AMP(2)+AMP(3)+AMP(4))
