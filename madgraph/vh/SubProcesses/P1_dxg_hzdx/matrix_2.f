...
C     
C     Process: g g > h z d d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: g g > h z s s~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,4))
      CALL FFV1_2(W(1,6),W(1,2),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,7),W(1,4),W(1,8),-GC_22,GC_23,AMP(3))
      CALL FFV1_1(W(1,4),W(1,2),GC_5,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,6),W(1,3),W(1,8),-GC_22,GC_23,AMP(4))
      CALL FFV1_2(W(1,6),W(1,1),GC_5,ZERO,ZERO,W(1,3))
      CALL FFV1_1(W(1,5),W(1,2),GC_5,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,3),W(1,4),W(1,8),-GC_22,GC_23,AMP(5))
      CALL FFV1_2(W(1,3),W(1,2),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,9),W(1,5),W(1,8),-GC_22,GC_23,AMP(6))
      CALL FFV1_1(W(1,4),W(1,1),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL FFV2_3_0(W(1,6),W(1,9),W(1,8),-GC_22,GC_23,AMP(7))
      CALL FFV1_2(W(1,7),W(1,1),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,9),W(1,5),W(1,8),-GC_22,GC_23,AMP(8))
