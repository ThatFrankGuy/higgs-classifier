...
C     
C     Process: d~ u~ > h z d~ u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: d~ c~ > h z d~ c~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ u~ > h z s~ u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ c~ > h z s~ c~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
