...
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,7),W(1,8),W(1,9),-GC_22,GC_23,AMP(1))
      CALL FFV1_2(W(1,7),W(1,6),GC_5,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,4),W(1,2),W(1,9),-GC_22,GC_23,AMP(2))
      CALL FFV1_2(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,4))
      CALL FFV1_1(W(1,2),W(1,5),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,4),W(1,7),W(1,9),-GC_22,GC_23,AMP(3))
      CALL FFV1_2(W(1,4),W(1,5),GC_5,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,9),-GC_22,GC_23,AMP(4))
      CALL FFV2_3_2(W(1,1),W(1,9),-GC_22,GC_23,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,3),W(1,7),W(1,6),GC_5,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,3),W(1,8),W(1,5),GC_5,AMP(6))
      CALL VVV1P0_1(W(1,5),W(1,6),GC_4,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_5,AMP(7))
      CALL FFV1_2(W(1,1),W(1,8),GC_5,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,9),-GC_22,GC_23,AMP(8))
      JAMP(1)=+AMP(3)+AMP(4)+AMP(5)-IMAG1*AMP(7)-IMAG1*AMP(8)
      JAMP(2)=+AMP(1)+AMP(2)+AMP(6)+IMAG1*AMP(7)+IMAG1*AMP(8)
      MATRIX_1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
