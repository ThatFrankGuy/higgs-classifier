...
C     
C     Process: d~ g > h w+ u~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ g > h w+ c~ g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,9),W(1,8),GC_47,AMP(4))
      CALL FFV2_1(W(1,1),W(1,8),GC_47,ZERO,ZERO,W(1,9))
