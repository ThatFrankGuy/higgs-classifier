...
C     
C     Process: d~ s > h w+ s u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: d~ c > h w+ c u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ d > h w+ d c~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ u > h w+ u c~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL VVS1_1(W(1,4),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,5))
      CALL FFV1_1(W(1,1),W(1,7),GC_5,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,6),W(1,4),W(1,5),GC_47,AMP(1))
      CALL FFV2_1(W(1,1),W(1,5),GC_47,ZERO,ZERO,W(1,4))
