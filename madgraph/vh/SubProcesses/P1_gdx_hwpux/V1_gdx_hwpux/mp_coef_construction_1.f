...
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL MP_FFV1L1P0_3(PL(0,9),W(1,2),GC_5,ZERO,ZERO,PL(0,10),COEFS)
...
C     Coefficient construction for loop diagram with ID 7
      CALL MP_FFV1L3_2(PL(0,10),W(1,5),GC_5,ZERO,ZERO,PL(0,12),COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1,12))
      CALL MP_FFV2L1_2(PL(0,12),W(1,7),GC_47,ZERO,ZERO,PL(0,13),COEFS)
...
C     Coefficient construction for loop diagram with ID 8
      ...
      CALL MP_FFV1L3_1(PL(0,14),W(1,2),GC_5,ZERO,ZERO,PL(0,15),COEFS)
