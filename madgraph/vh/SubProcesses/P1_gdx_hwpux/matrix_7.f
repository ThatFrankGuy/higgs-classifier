...
C     
C     Process: s d~ > h w+ s u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c d~ > h w+ c u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: d s~ > h w+ d c~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: u s~ > h w+ u c~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,2),W(1,5),GC_47,AMP(2))
