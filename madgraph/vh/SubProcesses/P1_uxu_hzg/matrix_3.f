...
C     
C     Process: u~ g > h z u~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ g > h z c~ g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,7))
      CALL FFV1_2(W(1,5),W(1,2),GC_5,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,3),W(1,7),W(1,8),GC_22,GC_23,AMP(3))
      CALL FFV1_1(W(1,7),W(1,2),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,5),W(1,9),W(1,8),GC_22,GC_23,AMP(4))
      CALL FFV2_5_1(W(1,1),W(1,8),GC_22,GC_23,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,3),W(1,9),W(1,6),GC_5,AMP(5))
      CALL VVV1P0_1(W(1,2),W(1,6),GC_4,ZERO,ZERO,W(1,3))
      CALL FFV1_1(W(1,1),W(1,3),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,5),W(1,6),W(1,8),GC_22,GC_23,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,5),W(1,9),W(1,3),GC_5,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,4),W(1,9),W(1,2),GC_5,AMP(8))
      JAMP(1)=-AMP(1)-AMP(2)+IMAG1*AMP(6)+IMAG1*AMP(7)-AMP(8)
      JAMP(2)=-AMP(3)-AMP(4)-AMP(5)-IMAG1*AMP(6)-IMAG1*AMP(7)
      MATRIX_3 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
