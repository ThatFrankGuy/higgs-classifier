...
C     
C     Process: u~ u > h z g QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     Process: c~ c > h z g QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,6),W(1,1),W(1,7),GC_22,GC_23,AMP(2))
