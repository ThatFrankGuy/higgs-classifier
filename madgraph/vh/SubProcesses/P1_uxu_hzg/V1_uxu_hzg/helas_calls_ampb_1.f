...
C     Amplitude(s) for born diagram with ID 1
      CALL FFV2_5_0(W(1,2),W(1,6),W(1,7),GC_22,GC_23,AMP(1))
...
C     Counter-term amplitude(s) for loop diagram number 7
      CALL FFV2_5_0(W(1,2),W(1,6),W(1,7),R2_UUZ_V2,R2_UUZ_V5,AMPL(1,5))
      CALL FFV2_5_2(W(1,2),W(1,7),GC_22,GC_23,ZERO,ZERO,W(1,10))
C     Counter-term amplitude(s) for loop diagram number 8
      CALL R2_QQ_1_0(W(1,10),W(1,6),R2_QQQ,AMPL(1,6))
...
C     Counter-term amplitude(s) for loop diagram number 11
      ...
      CALL FFV1_0(W(1,10),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,10))
      CALL FFV1_0(W(1,10),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,11))
      CALL FFV1_0(W(1,10),W(1,1),W(1,5),UV_GQQB,AMPL(1,12))
      CALL FFV1_0(W(1,10),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,13))
      CALL FFV1_0(W(1,10),W(1,1),W(1,5),UV_GQQT,AMPL(1,14))
      CALL FFV1_0(W(1,10),W(1,1),W(1,5),UV_GQQQ_1EPS,AMPL(2,15))
      CALL FFV1_0(W(1,10),W(1,1),W(1,5),UV_GQQG_1EPS,AMPL(2,16))
      CALL FFV1_0(W(1,10),W(1,1),W(1,5),R2_GQQ,AMPL(1,17))
...
C     Counter-term amplitude(s) for loop diagram number 16
      ...
      CALL FFV1_0(W(1,2),W(1,11),W(1,5),UV_GQQQ_1EPS,AMPL(2,21))
      CALL FFV1_0(W(1,2),W(1,11),W(1,5),UV_GQQQ_1EPS,AMPL(2,22))
      CALL FFV1_0(W(1,2),W(1,11),W(1,5),UV_GQQB,AMPL(1,23))
      CALL FFV1_0(W(1,2),W(1,11),W(1,5),UV_GQQQ_1EPS,AMPL(2,24))
      CALL FFV1_0(W(1,2),W(1,11),W(1,5),UV_GQQT,AMPL(1,25))
      CALL FFV1_0(W(1,2),W(1,11),W(1,5),UV_GQQQ_1EPS,AMPL(2,26))
      CALL FFV1_0(W(1,2),W(1,11),W(1,5),UV_GQQG_1EPS,AMPL(2,27))
      CALL FFV1_0(W(1,2),W(1,11),W(1,5),R2_GQQ,AMPL(1,28))
...
C     Counter-term amplitude(s) for loop diagram number 26
      ...
      CALL FFV2_5_2(W(1,2),W(1,4),GC_22,GC_23,ZERO,ZERO,W(1,14))
