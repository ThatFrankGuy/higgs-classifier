...
C     
C     Process: d u > h w- u u WEIGHTED<=6 [ all = QCD ] @1
C     Process: s c > h w- c c WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,6),W(1,8),GC_47,AMP(1))
      CALL FFV2_2(W(1,1),W(1,8),GC_47,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,6),W(1,7),GC_5,AMP(2))
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,4),W(1,5),W(1,7),GC_5,AMP(4))
