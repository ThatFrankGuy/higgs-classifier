...
C     Coefficient construction for loop diagram with ID 3
      ...
      CALL FFV2L2_1(PL(0,1),W(1,7),GC_47,ZERO,ZERO,PL(0,2),COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL FFV1L2_1(PL(0,11),W(1,5),GC_5,ZERO,ZERO,PL(0,12),COEFS)
...
C     Coefficient construction for loop diagram with ID 7
      CALL FFV1L1P0_3(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,13),COEFS)
...
C     Coefficient construction for loop diagram with ID 8
      ...
      CALL FFV1L3_1(PL(0,16),W(1,2),GC_5,ZERO,ZERO,PL(0,17),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,16),4,COEFS,4,4,WL(1,0,1,17))
      CALL FFV2L2_1(PL(0,17),W(1,7),GC_47,ZERO,ZERO,PL(0,18),COEFS)
...
C     Coefficient construction for loop diagram with ID 9
      CALL FFV1L2_1(PL(0,10),W(1,5),GC_5,ZERO,ZERO,PL(0,19),COEFS)
...
C     Coefficient construction for loop diagram with ID 10
      CALL FFV1L2_1(PL(0,1),W(1,5),GC_5,ZERO,ZERO,PL(0,21),COEFS)
...
C     Coefficient construction for loop diagram with ID 11
      CALL FFV1L2P0_3(PL(0,0),W(1,6),GC_5,ZERO,ZERO,PL(0,23),COEFS)
...
C     Coefficient construction for loop diagram with ID 12
      CALL FFV1L3_1(PL(0,16),W(1,10),GC_5,ZERO,ZERO,PL(0,25),COEFS)
...
C     Coefficient construction for loop diagram with ID 13
      CALL FFV1L1_2(PL(0,6),W(1,5),GC_5,ZERO,ZERO,PL(0,26),COEFS)
