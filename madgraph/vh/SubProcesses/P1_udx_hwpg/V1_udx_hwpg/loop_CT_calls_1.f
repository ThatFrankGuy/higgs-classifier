...
C     CutTools call for loop numbers 2
      CALL LOOP_2(8,9,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,2)
...
C     CutTools call for loop numbers 5,8
      CALL LOOP_3(2,5,9,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,5)
...
C     CutTools call for loop numbers 9
      CALL LOOP_2(6,10,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,8)
C     CutTools call for loop numbers 10,11
      CALL LOOP_3(1,5,10,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,9)
C     CutTools call for loop numbers 12,13,14,15
      CALL LOOP_3(3,5,12,DCMPLX(MDL_MB),DCMPLX(MDL_MB),DCMPLX(MDL_MB)
     $ ,3,I_SO,10)
C     CutTools call for loop numbers 16,17,18,19
      CALL LOOP_3(3,5,12,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,3,I_SO,11)
