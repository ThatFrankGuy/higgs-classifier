...
C     
C     Process: d u~ > h w- s s~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: d u~ > h w- c c~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: s c~ > h w- d d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: s c~ > h w- u u~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_2(W(1,1),W(1,7),GC_47,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,2),W(1,4),GC_5,AMP(1))
      CALL FFV1_2(W(1,1),W(1,4),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,6),W(1,2),W(1,7),GC_47,AMP(2))
