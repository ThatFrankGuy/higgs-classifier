...
C     Coefficient construction for loop diagram with ID 6
      CALL FFV1L1P0_3(PL(0,0),W(1,8),GC_5,ZERO,ZERO,PL(0,9),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,9))
      CALL FFV1L3_2(PL(0,9),W(1,10),GC_5,ZERO,ZERO,PL(0,10),COEFS)
...
C     Coefficient construction for loop diagram with ID 9
      CALL FFV1L2P0_3(PL(0,14),W(1,2),GC_5,ZERO,ZERO,PL(0,17),COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,14),4,COEFS,4,4,WL(1,0,1,17))
      CALL FFV1L3_1(PL(0,17),W(1,9),GC_5,ZERO,ZERO,PL(0,18),COEFS)
...
C     Coefficient construction for loop diagram with ID 10
      CALL FFV1L3_1(PL(0,17),W(1,5),GC_5,ZERO,ZERO,PL(0,19),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,19))
      CALL FFV2_3L2_1(PL(0,19),W(1,7),-GC_22,GC_23,ZERO,ZERO,PL(0,20)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 11
      CALL FFV1L1P0_3(PL(0,11),W(1,5),GC_5,ZERO,ZERO,PL(0,21),COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,11),4,COEFS,4,4,WL(1,0,1,21))
     ...
     $ ,COEFS)
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,23),3,4,8,1,1,47,H)
C     Coefficient construction for loop diagram with ID 12
      CALL FFV1L3_2(PL(0,21),W(1,10),GC_5,ZERO,ZERO,PL(0,24),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,24))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,24),2,4,9,1,1,48,H)
C     Coefficient construction for loop diagram with ID 13
      ...
      CALL FFV1L3_2(PL(0,25),W(1,2),GC_5,ZERO,ZERO,PL(0,26),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,25),4,COEFS,4,4,WL(1,0,1,26))
      CALL FFV1L1P0_3(PL(0,26),W(1,9),GC_5,ZERO,ZERO,PL(0,27),COEFS)
...
C     Coefficient construction for loop diagram with ID 14
      CALL FFV2_3L1_2(PL(0,26),W(1,7),-GC_22,GC_23,ZERO,ZERO,PL(0,28)
     $ ,COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,26),4,COEFS,4,4,WL(1,0,1,28))
      CALL FFV1L1P0_3(PL(0,28),W(1,5),GC_5,ZERO,ZERO,PL(0,29),COEFS)
...
C     Coefficient construction for loop diagram with ID 15
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,31),2,4,9,1,1,51,H)
