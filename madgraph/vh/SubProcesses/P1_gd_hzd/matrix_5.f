...
C     
C     Process: u d > h z d u WEIGHTED<=6 [ all = QCD ] @1
C     Process: c d > h z d c WEIGHTED<=6 [ all = QCD ] @1
C     Process: u s > h z s u WEIGHTED<=6 [ all = QCD ] @1
C     Process: c s > h z s c WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,5),W(1,6),W(1,8),GC_22,GC_23,AMP(3))
      CALL FFV2_5_2(W(1,1),W(1,8),GC_22,GC_23,ZERO,ZERO,W(1,5))
