...
C     
C     Process: u~ d > h w- g QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     Process: c~ s > h w- g QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      DATA (NHEL(I,  16),I=1,5) / 1, 1, 0, 0, 1/
      DATA (NHEL(I,  17),I=1,5) / 1, 1, 0,-1,-1/
      DATA (NHEL(I,  18),I=1,5) / 1, 1, 0,-1, 1/
      DATA (NHEL(I,  19),I=1,5) / 1,-1, 0, 1,-1/
      DATA (NHEL(I,  20),I=1,5) / 1,-1, 0, 1, 1/
      DATA (NHEL(I,  21),I=1,5) / 1,-1, 0, 0,-1/
      DATA (NHEL(I,  22),I=1,5) / 1,-1, 0, 0, 1/
      DATA (NHEL(I,  23),I=1,5) / 1,-1, 0,-1,-1/
      DATA (NHEL(I,  24),I=1,5) / 1,-1, 0,-1, 1/
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1_2(W(1,2),W(1,5),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,6),W(1,1),W(1,7),GC_47,AMP(2))
