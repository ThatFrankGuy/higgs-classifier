...
C     Coefficient construction for loop diagram with ID 3
      CALL FFV1L3_2(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,1),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,1))
      CALL FFV2L1_2(PL(0,1),W(1,7),GC_47,ZERO,ZERO,PL(0,2),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,2))
      CALL FFV1L1P0_3(PL(0,2),W(1,6),GC_5,ZERO,ZERO,PL(0,3),COEFS)
      CALL UPDATE_WL_2_0(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,3))
...
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL FFV2L1_2(PL(0,10),W(1,7),GC_47,ZERO,ZERO,PL(0,11),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1,11))
      CALL FFV1L1_2(PL(0,11),W(1,5),GC_5,ZERO,ZERO,PL(0,12),COEFS)
...
C     Coefficient construction for loop diagram with ID 7
      CALL FFV1L2P0_3(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,13),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,13))
      CALL VVV1L2P0_1(PL(0,13),W(1,5),GC_4,ZERO,ZERO,PL(0,14),COEFS)
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,15),2,4,5,1,1,37,H)
C     Coefficient construction for loop diagram with ID 8
      CALL VVV1L2P0_1(PL(0,9),W(1,5),GC_4,ZERO,ZERO,PL(0,16),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,9),4,COEFS,4,4,WL(1,0,1,16))
      CALL FFV1L3_2(PL(0,16),W(1,2),GC_5,ZERO,ZERO,PL(0,17),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,16),4,COEFS,4,4,WL(1,0,1,17))
      CALL FFV2L1_2(PL(0,17),W(1,7),GC_47,ZERO,ZERO,PL(0,18),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,18))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,18),3,4,6,1,1,38,H)
C     Coefficient construction for loop diagram with ID 9
      CALL FFV1L1_2(PL(0,10),W(1,5),GC_5,ZERO,ZERO,PL(0,19),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1,19))
      CALL FFV2L1_2(PL(0,19),W(1,7),GC_47,ZERO,ZERO,PL(0,20),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,19),4,COEFS,4,4,WL(1,0,1,20))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,20),3,4,7,1,1,39,H)
C     Coefficient construction for loop diagram with ID 10
      CALL FFV1L1_2(PL(0,1),W(1,5),GC_5,ZERO,ZERO,PL(0,21),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,1),4,COEFS,4,4,WL(1,0,1,21))
      CALL FFV1L1P0_3(PL(0,21),W(1,9),GC_5,ZERO,ZERO,PL(0,22),COEFS)
      CALL UPDATE_WL_2_0(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,22))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,22),2,4,5,1,1,40,H)
C     Coefficient construction for loop diagram with ID 11
      CALL FFV1L1P0_3(PL(0,0),W(1,6),GC_5,ZERO,ZERO,PL(0,23),COEFS)
...
C     Coefficient construction for loop diagram with ID 12
      CALL FFV1L3_2(PL(0,16),W(1,10),GC_5,ZERO,ZERO,PL(0,25),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,16),4,COEFS,4,4,WL(1,0,1,25))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,25),2,4,9,1,1,42,H)
C     Coefficient construction for loop diagram with ID 13
      CALL FFV1L2_1(PL(0,6),W(1,5),GC_5,ZERO,ZERO,PL(0,26),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,6),4,COEFS,4,4,WL(1,0,1,26))
