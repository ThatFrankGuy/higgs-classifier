...
C     
C     Process: u~ d > h w- g g WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ s > h w- g g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL VVS1_2(W(1,4),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,8),W(1,7),W(1,9),GC_47,AMP(1))
      CALL FFV1_1(W(1,7),W(1,6),GC_5,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,4),W(1,9),GC_47,AMP(2))
      CALL FFV1_1(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,4))
      CALL FFV1_2(W(1,2),W(1,5),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,7),W(1,4),W(1,9),GC_47,AMP(3))
      CALL FFV1_1(W(1,4),W(1,5),GC_5,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,2),W(1,3),W(1,9),GC_47,AMP(4))
      CALL FFV2_1(W(1,1),W(1,9),GC_47,ZERO,ZERO,W(1,3))
...
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,2),W(1,3),W(1,9),GC_47,AMP(8))
