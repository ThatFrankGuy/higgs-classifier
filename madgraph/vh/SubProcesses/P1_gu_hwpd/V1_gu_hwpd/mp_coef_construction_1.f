...
C     Coefficient construction for loop diagram with ID 7
      ...
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,13),2,4,5,1,1,37,H)
C     Coefficient construction for loop diagram with ID 8
      ...
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,16),2,4,5,1,1,38,H)
C     Coefficient construction for loop diagram with ID 9
      CALL MP_FFV1L3_2(PL(0,14),W(1,2),GC_5,ZERO,ZERO,PL(0,17),COEFS)
...
C     Coefficient construction for loop diagram with ID 10
      ...
      CALL MP_FFV1L2P0_3(PL(0,20),W(1,2),GC_5,ZERO,ZERO,PL(0,21),COEFS)
      CALL MP_UPDATE_WL_1_0(WL(1,0,1,20),4,COEFS,4,4,WL(1,0,1,21))
      CALL MP_FFV1L3_1(PL(0,21),W(1,5),GC_5,ZERO,ZERO,PL(0,22),COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,22))
      CALL MP_FFV2L2_1(PL(0,22),W(1,7),GC_47,ZERO,ZERO,PL(0,23),COEFS)
...
C     Coefficient construction for loop diagram with ID 11
      CALL MP_FFV1L2P0_3(PL(0,0),W(1,6),GC_5,ZERO,ZERO,PL(0,24),COEFS)
...
C     Coefficient construction for loop diagram with ID 12
      CALL MP_FFV1L3_1(PL(0,21),W(1,10),GC_5,ZERO,ZERO,PL(0,26),COEFS)
...
C     Coefficient construction for loop diagram with ID 13
      CALL MP_FFV1L1P0_3(PL(0,17),W(1,10),GC_5,ZERO,ZERO,PL(0,27)
     $ ,COEFS)
