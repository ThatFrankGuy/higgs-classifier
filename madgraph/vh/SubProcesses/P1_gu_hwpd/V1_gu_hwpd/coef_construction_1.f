...
C     Coefficient construction for loop diagram with ID 7
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,13),2,4,5,1,1,37,H)
C     Coefficient construction for loop diagram with ID 8
      ...
      CALL CREATE_LOOP_COEFS(WL(1,0,1,16),2,4,5,1,1,38,H)
C     Coefficient construction for loop diagram with ID 9
      CALL FFV1L3_2(PL(0,14),W(1,2),GC_5,ZERO,ZERO,PL(0,17),COEFS)
      ...
      CALL UPDATE_WL_3_0(WL(1,0,1,18),4,COEFS,4,4,WL(1,0,1,19))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,19),3,4,6,1,1,39,H)
C     Coefficient construction for loop diagram with ID 10
      ...
      CALL FFV1L2P0_3(PL(0,20),W(1,2),GC_5,ZERO,ZERO,PL(0,21),COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,20),4,COEFS,4,4,WL(1,0,1,21))
      CALL FFV1L3_1(PL(0,21),W(1,5),GC_5,ZERO,ZERO,PL(0,22),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,22))
      CALL FFV2L2_1(PL(0,22),W(1,7),GC_47,ZERO,ZERO,PL(0,23),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,22),4,COEFS,4,4,WL(1,0,1,23))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,23),3,4,7,1,1,40,H)
C     Coefficient construction for loop diagram with ID 11
      CALL FFV1L2P0_3(PL(0,0),W(1,6),GC_5,ZERO,ZERO,PL(0,24),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,24))
      CALL FFV1L3_1(PL(0,24),W(1,10),GC_5,ZERO,ZERO,PL(0,25),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1,25))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,25),1,4,8,1,1,41,H)
C     Coefficient construction for loop diagram with ID 12
      CALL FFV1L3_1(PL(0,21),W(1,10),GC_5,ZERO,ZERO,PL(0,26),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,26))
      CALL CREATE_LOOP_COEFS(WL(1,0,1,26),2,4,9,1,1,42,H)
C     Coefficient construction for loop diagram with ID 13
      CALL FFV1L1P0_3(PL(0,17),W(1,10),GC_5,ZERO,ZERO,PL(0,27),COEFS)
      CALL UPDATE_WL_2_0(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,27))
