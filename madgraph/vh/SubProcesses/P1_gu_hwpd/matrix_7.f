...
C     
C     Process: s u > h w+ d s WEIGHTED<=6 [ all = QCD ] @1
C     Process: c u > h w+ d c WEIGHTED<=6 [ all = QCD ] @1
C     Process: d c > h w+ s d WEIGHTED<=6 [ all = QCD ] @1
C     Process: u c > h w+ s u WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL VVS1_1(W(1,4),W(1,3),GC_31,MDL_MW,MDL_WW,W(1,6))
      CALL FFV1_2(W(1,2),W(1,7),GC_5,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,5),W(1,6),GC_47,AMP(1))
      CALL FFV1_1(W(1,5),W(1,7),GC_5,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,4),W(1,6),GC_47,AMP(2))
      JAMP(1)=+1D0/2D0*(+AMP(1)+AMP(2))
      JAMP(2)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2))
      MATRIX_7 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
