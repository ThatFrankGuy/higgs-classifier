...
C     
C     Process: s d > h w- u s WEIGHTED<=6 [ all = QCD ] @1
C     Process: c d > h w- u c WEIGHTED<=6 [ all = QCD ] @1
C     Process: d s > h w- c d WEIGHTED<=6 [ all = QCD ] @1
C     Process: u s > h w- c u WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
