...
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL MP_FFV1L2P0_3(PL(0,9),W(1,2),GC_5,ZERO,ZERO,PL(0,10),COEFS)
...
C     Coefficient construction for loop diagram with ID 7
      CALL MP_FFV1L3_1(PL(0,10),W(1,5),GC_5,ZERO,ZERO,PL(0,12),COEFS)
...
C     Coefficient construction for loop diagram with ID 8
      ...
      CALL MP_FFV1L3_2(PL(0,14),W(1,2),GC_5,ZERO,ZERO,PL(0,15),COEFS)
...
C     Coefficient construction for loop diagram with ID 9
      CALL MP_FFV2L1_2(PL(0,15),W(1,7),GC_47,ZERO,ZERO,PL(0,17),COEFS)
      ...
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,18),3,4,6,1,1,39,H)
C     Coefficient construction for loop diagram with ID 10
      CALL MP_FFV1L1_2(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,19),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,19))
      CALL MP_FFV1L1P0_3(PL(0,19),W(1,5),GC_5,ZERO,ZERO,PL(0,20),COEFS)
      ...
      CALL MP_FFV2L1_2(PL(0,21),W(1,7),GC_47,ZERO,ZERO,PL(0,22),COEFS)
      CALL MP_UPDATE_WL_2_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,22))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,22),3,4,7,1,1,40,H)
C     Coefficient construction for loop diagram with ID 11
      CALL MP_FFV1L1P0_3(PL(0,0),W(1,8),GC_5,ZERO,ZERO,PL(0,23),COEFS)
...
C     Coefficient construction for loop diagram with ID 12
      CALL MP_FFV1L3_2(PL(0,20),W(1,10),GC_5,ZERO,ZERO,PL(0,25),COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,20),4,COEFS,4,4,WL(1,0,1,25))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,25),2,4,9,1,1,42,H)
C     Coefficient construction for loop diagram with ID 13
      CALL MP_FFV1L3_1(PL(0,14),W(1,5),GC_5,ZERO,ZERO,PL(0,26),COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,14),4,COEFS,4,4,WL(1,0,1,26))
