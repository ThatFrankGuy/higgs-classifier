...
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL FFV1L1_2(PL(0,10),W(1,5),GC_5,ZERO,ZERO,PL(0,11),COEFS)
...
C     Coefficient construction for loop diagram with ID 7
      ...
      CALL FFV1L3_2(PL(0,13),W(1,9),GC_5,ZERO,ZERO,PL(0,14),COEFS)
...
C     Coefficient construction for loop diagram with ID 8
      CALL FFV1L3_2(PL(0,13),W(1,2),GC_5,ZERO,ZERO,PL(0,15),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,13),4,COEFS,4,4,WL(1,0,1,15))
      CALL FFV2L1_2(PL(0,15),W(1,7),GC_47,ZERO,ZERO,PL(0,16),COEFS)
...
C     Coefficient construction for loop diagram with ID 9
      CALL FFV2L1_2(PL(0,10),W(1,7),GC_47,ZERO,ZERO,PL(0,17),COEFS)
...
C     Coefficient construction for loop diagram with ID 10
      CALL FFV1L2_1(PL(0,6),W(1,5),GC_5,ZERO,ZERO,PL(0,19),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,6),4,COEFS,4,4,WL(1,0,1,19))
      CALL FFV1L2P0_3(PL(0,19),W(1,9),GC_5,ZERO,ZERO,PL(0,20),COEFS)
...
C     Coefficient construction for loop diagram with ID 12
      CALL FFV1L2P0_3(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,23),COEFS)
...
C     Coefficient construction for loop diagram with ID 13
      CALL FFV1L1_2(PL(0,3),W(1,5),GC_5,ZERO,ZERO,PL(0,26),COEFS)
