...
C     
C     Process: d~ g > h z d~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ g > h z s~ g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,5),W(1,9),W(1,8),-GC_22,GC_23,AMP(4))
      CALL FFV2_3_1(W(1,1),W(1,8),-GC_22,GC_23,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,5),W(1,6),W(1,8),-GC_22,GC_23,AMP(6))
