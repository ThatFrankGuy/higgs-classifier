...
C     
C     Process: d~ d > h z u u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: d~ d > h z c c~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ s > h z u u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ s > h z c c~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,6),W(1,5),GC_5,ZERO,ZERO,W(1,4))
      CALL FFV2_3_1(W(1,1),W(1,8),-GC_22,GC_23,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,2),W(1,6),W(1,4),GC_5,AMP(3))
      CALL FFV1_1(W(1,1),W(1,4),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,2),W(1,6),W(1,8),-GC_22,GC_23,AMP(4))
      JAMP(1)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)
     $ -1D0/3D0*AMP(4))
      JAMP(2)=+1D0/2D0*(+AMP(1)+AMP(2)+AMP(3)+AMP(4))
      MATRIX_5 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
