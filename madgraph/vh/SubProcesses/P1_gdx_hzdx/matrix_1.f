...
C     
C     Process: g d~ > h z d~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: g s~ > h z s~ g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,6),W(1,2),W(1,8),-GC_22,GC_23,AMP(8))
