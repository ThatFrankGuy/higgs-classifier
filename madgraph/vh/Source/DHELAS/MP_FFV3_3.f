...
C     
     ...
     $ * W3))
      V3(5)= DENOM*2Q0 * CI*(OM3*1Q0/2Q0 * P3(0)*(TMP4-2Q0*(TMP7))+(
     $ -1Q0/2Q0*(F2(7)*F1(5)+F2(8)*F1(6))+F2(5)*F1(7)+F2(6)*F1(8)))
      V3(6)= DENOM*2Q0 * CI*(OM3*1Q0/2Q0 * P3(1)*(TMP4-2Q0*(TMP7))+(
     $ +1Q0/2Q0*(F2(8)*F1(5)+F2(7)*F1(6))+F2(6)*F1(7)+F2(5)*F1(8)))
      V3(7)= DENOM*(-2Q0 * CI)*(OM3*1Q0/2Q0 * P3(2)*(+2Q0*(TMP7)-TMP4)
     $ +(-1Q0/2Q0 * CI*(F2(8)*F1(5))+1Q0/2Q0 * CI*(F2(7)*F1(6))-CI
     $ *(F2(6)*F1(7))+CI*(F2(5)*F1(8))))
      V3(8)= DENOM*(-2Q0 * CI)*(OM3*1Q0/2Q0 * P3(3)*(+2Q0*(TMP7)-TMP4)
