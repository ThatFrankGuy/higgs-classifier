...
C     
C     Process: g g > h g WEIGHTED<=8 [ noborn = QCD ]
C     
C     Modules
C     
...
C      reading the parameters
     ...
     $ ,FORCED_CHOICE_OF_COLLIER_IR_POLE_COMPUTATION/.FALSE.,.FALSE./
      COMMON/ML5_0_0_1_COLLIERPOLESFORCEDCHOICE/FORCED_CHOICE_OF_COLLIE
...
C         Handle the possible requirement of specific polarizations
     ...
     $0,0).EQ.0.AND.(.NOT.ML5_0_0_1_IS_HEL_SELECTED(H))) THEN
            CYCLE
          ENDIF
          ...
          IF (DIRECT_ME_COMPUTATION) THEN
            DO I=1,NLOOPAMPS
              DO J=1,NLOOPAMPS
                ...
                ITEMP = ML5_0_0_1_ML5SQSOINDEX(ML5_0_0_1_ML5SOINDEX_FOR
     $_LOOP_AMP(I),ML5_0_0_1_ML5SOINDEX_FOR_LOOP_AMP(J))
...
C                out this helicity
                IF (POLARIZATIONS(0,0).EQ.-1.OR.ML5_0_0_1_IS_HEL_SELECT
     $ED(H)) THEN
...
C                out this helicity
                IF (POLARIZATIONS(0,0).EQ.-1.OR.ML5_0_0_1_IS_HEL_SELECT
     $ED(H)) THEN
                  CALL ML5_0_0_1_COMPUTE_COLOR_FLOWS_DERIVED_QUANTITIES
     $(HEL_MULT)
                ENDIF
              ENDIF
            ENDIF
...
C          this helicity
          IF (POLARIZATIONS(0,0).EQ.-1.OR.ML5_0_0_1_IS_HEL_SELECTED(HEL
     $PICKED)) THEN
...
C     
 ...
 1009   CONTINUE
      ...
      WRITE(*,*) 'ERROR:: Stopping function ML5_0_0_1_ML5SOINDEX_FOR_SQ'
     $ //'UARED_ORDERS'
...
C     
      ...
      WRITE(*,*) 'ERROR:: Stopping function ML5_0_0_1_ML5GET_SQUARED_OR'
     $ //'DERS_FOR_SOINDEX'
...
C     
      ...
      WRITE(*,*) 'ERROR:: Stopping function ML5_0_0_1_ML5GET_ORDERS_FOR'
     $ //'_AMPSOINDEX'
...
C     
 ...
 1009   CONTINUE
      ...
      WRITE(*,*) 'ERROR:: Stopping function ML5_0_0_1_ML5SOINDEX_FOR_AM'
     $ //'PORDERS'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
