...
C     CutTools call for loop # 13
      CALL ML5_0_0_1_LOOP_3(3,4,5,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),3,I_SO,13)
C     CutTools call for loop # 14
      CALL ML5_0_0_1_LOOP_3(3,4,5,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),3,I_SO,14)
C     CutTools call for loop # 15
      CALL ML5_0_0_1_LOOP_3(2,3,6,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),3,I_SO,15)
C     CutTools call for loop # 16
      CALL ML5_0_0_1_LOOP_3(2,3,6,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),3,I_SO,16)
C     CutTools call for loop # 17
      CALL ML5_0_0_1_LOOP_3(1,3,7,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
