...
C     Counter-term amplitude(s) for loop diagram number 1
      CALL VVS1_0(W(1,4),W(1,5),W(1,3),R2_GGHB,AMPL(1,1))
      CALL VVV1P0_1(W(1,1),W(1,4),GC_4,ZERO,ZERO,W(1,6))
C     Counter-term amplitude(s) for loop diagram number 3
      CALL VVS1_0(W(1,2),W(1,6),W(1,3),R2_GGHB,AMPL(1,2))
      CALL VVV1P0_1(W(1,2),W(1,4),GC_4,ZERO,ZERO,W(1,7))
C     Counter-term amplitude(s) for loop diagram number 5
      CALL VVS1_0(W(1,1),W(1,7),W(1,3),R2_GGHB,AMPL(1,3))
C     Counter-term amplitude(s) for loop diagram number 13
      CALL VVS1_0(W(1,4),W(1,5),W(1,3),R2_GGHT,AMPL(1,4))
C     Counter-term amplitude(s) for loop diagram number 15
      CALL VVS1_0(W(1,2),W(1,6),W(1,3),R2_GGHT,AMPL(1,5))
C     Counter-term amplitude(s) for loop diagram number 17
      CALL VVS1_0(W(1,1),W(1,7),W(1,3),R2_GGHT,AMPL(1,6))
