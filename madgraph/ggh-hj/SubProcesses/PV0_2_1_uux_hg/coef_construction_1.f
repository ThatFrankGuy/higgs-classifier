...
C     Coefficient construction for loop diagram with ID 1
      ...
      CALL ML5_0_2_1_CREATE_LOOP_COEFS(WL(1,0,1,3),3,4,1,1,1,3)
C     Coefficient construction for loop diagram with ID 2
      ...
      CALL ML5_0_2_1_CREATE_LOOP_COEFS(WL(1,0,1,6),3,4,2,1,1,4)
C     Coefficient construction for loop diagram with ID 3
      CALL FFS1L2_1(PL(0,0),W(1,3),GC_37,MDL_MT,MDL_WT,PL(0,7),COEFS)
      CALL ML5_0_2_1_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,7))
      CALL FFV1L2_1(PL(0,7),W(1,4),GC_5,MDL_MT,MDL_WT,PL(0,8),COEFS)
      CALL ML5_0_2_1_UPDATE_WL_1_1(WL(1,0,1,7),4,COEFS,4,4,WL(1,0,1,8))
      CALL FFV1L2_1(PL(0,8),W(1,5),GC_5,MDL_MT,MDL_WT,PL(0,9),COEFS)
      CALL ML5_0_2_1_UPDATE_WL_2_1(WL(1,0,1,8),4,COEFS,4,4,WL(1,0,1,9))
      CALL ML5_0_2_1_CREATE_LOOP_COEFS(WL(1,0,1,9),3,4,3,1,1,5)
C     Coefficient construction for loop diagram with ID 4
      CALL FFS1L1_2(PL(0,0),W(1,3),GC_37,MDL_MT,MDL_WT,PL(0,10),COEFS)
      CALL ML5_0_2_1_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,10)
     $ )
      CALL FFV1L1_2(PL(0,10),W(1,4),GC_5,MDL_MT,MDL_WT,PL(0,11),COEFS)
      CALL ML5_0_2_1_UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1
     $ ,11))
      CALL FFV1L1_2(PL(0,11),W(1,5),GC_5,MDL_MT,MDL_WT,PL(0,12),COEFS)
      CALL ML5_0_2_1_UPDATE_WL_2_1(WL(1,0,1,11),4,COEFS,4,4,WL(1,0,1
     $ ,12))
      CALL ML5_0_2_1_CREATE_LOOP_COEFS(WL(1,0,1,12),3,4,4,1,1,6)
