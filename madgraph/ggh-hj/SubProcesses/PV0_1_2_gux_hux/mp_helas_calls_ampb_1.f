      SUBROUTINE ML5_0_1_2_MP_HELAS_CALLS_AMPB_1(P,NHEL,H,IC)
C     
...
C      if true.
      ...
      CALL MP_FFV1P0_3(W(1,4),W(1,2),GC_5,ZERO,ZERO,W(1,5))
C     Counter-term amplitude(s) for loop diagram number 1
      CALL MP_VVS1_0(W(1,1),W(1,5),W(1,3),R2_GGHB,AMPL(1,1))
C     Counter-term amplitude(s) for loop diagram number 3
      CALL MP_VVS1_0(W(1,1),W(1,5),W(1,3),R2_GGHT,AMPL(1,2))
